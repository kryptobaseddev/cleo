...
// === Task Domain Types (Wave 1 Refactor — T1435) ===
// Per-operation Params/Result types were REMOVED in T1445 (Wave 1 of T1435).
// The dispatch layer now infers types directly from Core functions via OpsFromCore.
// See packages/cleo/src/dispatch/domains/tasks.ts for TasksOps definition.
export type {
  MinimalTask,
  TaskOp,
  TaskPriority,
