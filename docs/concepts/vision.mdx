---
title: "CLEO Vision"
description: "The immutable vision for CLEO as a portable Brain and Memory system for AI agents"
icon: "compass"
---
...
CLEO uses an interface-layer architecture with a single semantic contract:
...
<CardGroup cols={2}>
  <Card title="Current State (Shipped)" icon="check">
    Bash-native CLI, deterministic validation, atomic operations, audit logs, hierarchy lifecycle, and project-local memory are production baseline.
  </Card>
  <Card title="Strategic Direction (Gated)" icon="road">
    MCP maturity, Nexus validation, and Tier M/L cognitive infrastructure expansion follow evidence-gated roadmap progression.
  </Card>
</CardGroup>
