import { D as DevalueError, k as is_primitive, m as get_type, o as is_plain_object, p as enumerable_symbols, q as stringify_key, t as stringify_string, v as valid_array_indices, x as render, y as set, L as LEGACY_PROPS, z as get, A as flushSync, B as define_property, C as mutable_source, E as init_operations, F as get_first_child, G as get_next_sibling, H as HYDRATION_ERROR, I as set_hydrating, J as set_hydrate_node, K as hydration_failed, M as clear_text_content, N as component_root, O as hydrate_node, b as setContext, P as derived, Q as create_text, R as boundary, S as array_from, T as is_passive_event, U as set_active_reaction, V as set_active_effect, W as active_reaction, X as active_effect, Y as hydrating, Z as push, _ as component_context, $ as hydration_mismatch, a0 as pop } from './dev-YtqJX9rn.js';
import 'node:module';
...
async function get_hooks() {
	...
	let init;
	({handle, handleFetch, handleError, handleValidationError, init} = await import('./hooks.server-C6jGE3Ht.js'));
	let reroute;
	let transport;
	return {
		handle,
