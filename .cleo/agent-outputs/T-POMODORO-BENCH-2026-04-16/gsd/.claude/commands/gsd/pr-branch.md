...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
