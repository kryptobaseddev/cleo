...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/explore.md
</execution_context>

<process>
Execute the explore workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/explore.md end-to-end.
</process>
