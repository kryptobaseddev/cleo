...
import { AUDIT_RULES, getCategories, getRulesByCategory, getRulesBySeverity, } from "../../src/core/skills/audit/rules.js";
...
describe("skills audit scanner", () => {
    ...
    describe("scanFile", () => {
        ...
        it("calculates score based on severity weights", async () => {
            ...
            mocks.readFile.mockResolvedValue("Install packages: npm install some-package\n" +
        ...
        it("includes line numbers in findings", async () => {
            mocks.existsSync.mockReturnValue(true);
            mocks.readFile.mockResolvedValue("Line 1: safe\nLine 2: safe\nLine 3: rm -rf /");
            const result = await scanFile("/multiline.md");
            const destructiveFinding = result.findings.find((f) => f.rule.id === "CI001");
...
//# sourceMappingURL=skills-audit.test.js.map