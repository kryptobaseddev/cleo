---
title: "Multi-Agent Abstraction"
description: "Agent-agnostic CLI abstraction supporting Claude Code, Gemini, Codex, and Kimi with full backwards compatibility"
icon: "file-code"
---
...
| Log file | `.cleo/todo-log.jsonl` | `.cleo/todo-log.jsonl` |
