...
**File**: `.opencode/agent/cleo-subagent.md`
...
Load the shared CLEO base protocol and execute the provided spawn prompt.
```

```bash
opencode run --agent cleo-subagent "Execute task T2403"
```
