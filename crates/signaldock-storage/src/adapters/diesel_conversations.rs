...
/// Generates `ConversationRepository` impl for a concrete connection type.
macro_rules! impl_conversation_repository {
    ($conn:ty) => {
        #[async_trait]
        impl ConversationRepository for DieselStore<$conn> {
...
#[cfg(feature = "sqlite")]
impl_conversation_repository!(SqliteConn);

#[cfg(feature = "postgres")]
impl_conversation_repository!(PgConn);
