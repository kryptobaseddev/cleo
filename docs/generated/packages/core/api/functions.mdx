...
> **Deprecated**: Use the provider-agnostic reconciliation engine instead:   import  reconcile  from '../reconciliation/index.js';   import  ClaudeCodeTaskSyncProvider  from 'cleocode/adapters';  This function is preserved for backward compatibility.
