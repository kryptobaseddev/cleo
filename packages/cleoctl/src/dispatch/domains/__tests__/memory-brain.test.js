...
describe('MemoryHandler (brain.db backed)', () => {
    ...
    describe('query: find', () => {
        it('should return brain.db FTS5 search results', async () => {
            ...
            expect(memoryFind).toHaveBeenCalledWith(expect.objectContaining({ query: 'test search' }), '/mock/project');
        });
    ...
    describe('query: timeline', () => {
        it('should return chronological context around anchor', async () => {
            ...
            expect(result.success).toBe(true);
            expect(memoryTimeline).toHaveBeenCalledWith(expect.objectContaining({ anchor: 'D001' }), '/mock/project');
        });
        it('should pass depth params', async () => {
            ...
            expect(memoryTimeline).toHaveBeenCalledWith({ anchor: 'D001', depthBefore: 3, depthAfter: 2 }, '/mock/project');
        });
    ...
    describe('query: decision.find', () => {
        it('should search decisions in brain.db', async () => {
            ...
            expect(result.success).toBe(true);
            expect(memoryDecisionFind).toHaveBeenCalledWith(expect.objectContaining({ query: 'SQLite' }), '/mock/project');
        });
        it('should pass taskId and limit params', async () => {
            ...
            expect(memoryDecisionFind).toHaveBeenCalledWith({ query: undefined, taskId: 'T5241', limit: 10 }, '/mock/project');
        });
    });
    // =========================================================================
    ...
    describe('query: pattern.find', () => {
        it('should search patterns in brain.db', async () => {
            ...
            expect(result.success).toBe(true);
            expect(memoryPatternFind).toHaveBeenCalledWith(expect.objectContaining({ type: 'workflow' }), '/mock/project');
        });
    });
    // =========================================================================
    ...
    describe('query: learning.find', () => {
        it('should search learnings in brain.db', async () => {
            ...
            expect(result.success).toBe(true);
            expect(memoryLearningFind).toHaveBeenCalledWith(expect.objectContaining({ query: 'test', actionableOnly: true }), '/mock/project');
        });
    });
    // =========================================================================
    ...
    describe('mutate: observe', () => {
        it('should save observation to brain.db', async () => {
            ...
            expect(memoryObserve).toHaveBeenCalledWith(expect.objectContaining({ text: 'Test observation', title: 'Test', type: 'discovery' }), '/mock/project');
        });
    ...
    describe('mutate: decision.store', () => {
        it('should save decision to brain.db', async () => {
            ...
            expect(result.success).toBe(true);
            expect(memoryDecisionStore).toHaveBeenCalledWith(expect.objectContaining({
                decision: 'Use TypeScript',
                rationale: 'Type safety',
                alternatives: ['JavaScript'],
                taskId: 'T5241',
    ...
    describe('mutate: pattern.store', () => {
        it('should save pattern to brain.db', async () => {
            ...
            expect(result.success).toBe(true);
            expect(memoryPatternStore).toHaveBeenCalledWith(expect.objectContaining({ pattern: 'Search then fetch pattern', context: 'API design' }), '/mock/project');
        });
    ...
    describe('mutate: learning.store', () => {
        it('should save learning to brain.db', async () => {
            ...
            expect(result.success).toBe(true);
            expect(memoryLearningStore).toHaveBeenCalledWith(expect.objectContaining({
                insight: 'FTS5 improves search quality',
                source: 'T5241',
                confidence: 0.9,
                actionable: true,
    ...
    describe('mutate: link', () => {
        it('should link brain entry to task', async () => {
            ...
            expect(result.success).toBe(true);
            expect(memoryLink).toHaveBeenCalledWith({ taskId: 'T5241', entryId: 'D001' }, '/mock/project');
        });
...
//# sourceMappingURL=memory-brain.test.js.map