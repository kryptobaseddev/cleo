...
describe("coverage: instructions inject", () => {
    ...
    it("exits with format conflict error", async () => {
        ...
        const program = new Command();
        registerInstructionsInject(program);
        await expect(program.parseAsync(["node", "test", "inject", "--all", "--json", "--human"])).rejects.toThrow("process-exit");
    ...
    it("exits with human error when no providers found", async () => {
        ...
        const program = new Command();
        registerInstructionsInject(program);
        await expect(program.parseAsync(["node", "test", "inject", "--agent", "unknown", "--human"])).rejects.toThrow("process-exit");
    ...
    it("exits with json error when no providers found", async () => {
        ...
        const program = new Command();
        registerInstructionsInject(program);
        await expect(program.parseAsync(["node", "test", "inject", "--agent", "unknown", "--json"])).rejects.toThrow("process-exit");
...
//# sourceMappingURL=coverage-instructions.test.js.map