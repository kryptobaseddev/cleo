...
import { ensureArray, sanitizeParams, sanitizeTaskId } from '../security.js';
...
describe('dispatch security sanitizeParams', () => {
    it('accepts lifecycle stage status for pipeline.stage.record', () => {
        const result = sanitizeParams({ taskId: 'T4798', stage: 'research', status: 'in_progress' }, undefined, { domain: 'pipeline', operation: 'stage.record' });
