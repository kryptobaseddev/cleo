...
Reference full template: `/tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/state.md`.
