...
<required_reading>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /tmp/pomodoro-bench/gsd/.claude
                  → checks /tmp/pomodoro-bench/gsd/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /tmp/pomodoro-bench/gsd/.claude/get-shit-done
                  → writes to /tmp/pomodoro-bench/gsd/.claude/get-shit-done/hooks/
...
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
