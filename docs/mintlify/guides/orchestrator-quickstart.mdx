...
1. Set focus to T002
2. Perform the work
3. Write findings to `.cleo/agent-outputs/`
...
ls .cleo/agent-outputs/*.md | tail -1

# Manually append entry if needed
echo '{"id":"manual-entry-2026-01-20",...}' >> .cleo/agent-outputs/MANIFEST.jsonl
```
