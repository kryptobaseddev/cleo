...
description: "Output verification and compliance protocol"
icon: "shield-check"
---

{/* AUTO-GENERATED from protocols/validation.md - DO NOT EDIT DIRECTLY */}
{/* Source of truth: /protocols/validation.md */}
