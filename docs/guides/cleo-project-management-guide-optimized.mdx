---
title: "CLEO Project Management Guide (Optimized)"
description: "Optimized guide for building and managing epics, tasks, and subtasks with dependencies and phases"
---
