...
describe('ResearchHandler', () => {
  ...
  describe('getSupportedOperations', () => {
    it('should return correct operation lists', () => {
      ...
      expect(operations.query).toEqual(['list', 'stats', 'validate', 'find', 'export', 'manifest.read', 'manifest.validate', 'manifest.summary', 'show', 'pending', 'contradictions', 'superseded']);
