...
export function parseIssueTemplates(
  projectRoot: string,
): EngineResult<import('../../core/templates/parser.js').TemplateConfig> {
...
export function getTemplateForSubcommand(
  projectRoot: string,
  subcommand: string,
): EngineResult<import('../../core/templates/parser.js').IssueTemplate> {
...
export async function generateTemplateConfig(
  projectRoot: string,
): Promise<EngineResult<import('../../core/templates/parser.js').TemplateConfig>> {
