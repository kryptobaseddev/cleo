---
title: "Epic Architect Skill Guide"
description: "Quick start guide for using the ct-epic-architect skill to create epics and decompose projects into manageable tasks"
---
...
| Existing epic needs work | Resume session, `cleo start` |
...
```
.cleo/agent-outputs/YYYY-MM-DD_epic-{slug}.md
```
...
Appends to:
```
.cleo/agent-outputs/MANIFEST.jsonl
```
