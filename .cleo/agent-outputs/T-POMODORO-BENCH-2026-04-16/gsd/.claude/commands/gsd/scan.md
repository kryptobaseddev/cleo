...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/scan.md end-to-end.
</process>
