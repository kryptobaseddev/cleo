...
**Issues Found**:
- Nexus operates on file-based JSON (`~/.cleo/cleo-nexus-registry.json`), not SQLite. ADR-006 mandates SQLite for Nexus (`nexus.db`). This is a known gap per ADR-009 Section 8 #4.
