...
import { buildTree, flattenTree, getChildIds, getChildren, getDepth, getDescendantIds, getDescendants, getParentChain, getParentChainIds, getRootAncestor, getSiblings, isAncestorOf, isDescendantOf, validateHierarchy, wouldCreateCircle, } from '../hierarchy.js';
...
describe('validateHierarchy', () => {
    ...
    it('rejects exceeding sibling limit', () => {
        const children = Array.from({ length: 7 }, (_, i) => makeTask({ id: `T00${i + 2}`, parentId: 'T001' }));
