...
| Property        | Type                                                                                                     | Description   |
| --------------- | -------------------------------------------------------------------------------------------------------- | ------------- |
| `agentType`     | `"custom" \| "orchestrator" \| "executor" \| "researcher" \| "architect" \| "validator" \| "documentor"` | agentType     |
...
| Property        | Type                                                                                                     | Description                                     |
| --------------- | -------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| `agentType`     | `"custom" \| "orchestrator" \| "executor" \| "researcher" \| "architect" \| "validator" \| "documentor"` | Agent type classification.                      |
