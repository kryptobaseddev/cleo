...
describe('brain.db PageIndex graph tables', () => {
    ...
    it('creates brain_page_nodes and brain_page_edges tables', async () => {
        ...
        const tables = nativeDb
            .prepare("SELECT name FROM sqlite_master WHERE type='table' AND name LIKE 'brain_page_%' ORDER BY name")
            .all();
    ...
    it('creates expected PageIndex indexes', async () => {
        ...
        const indexes = nativeDb
            .prepare("SELECT name FROM sqlite_master WHERE type='index' AND name LIKE 'idx_brain_%' ORDER BY name")
            .all();
    ...
    it('inserts and queries page nodes', async () => {
        ...
        expect(nativeDb).toBeTruthy();
        nativeDb
            .prepare('INSERT INTO brain_page_nodes (id, node_type, label, metadata_json) VALUES (?, ?, ?, ?)')
        ...
        const nodes = nativeDb.prepare('SELECT * FROM brain_page_nodes ORDER BY id').all();
    ...
    it('inserts and queries page edges', async () => {
        ...
        // Insert edge
        nativeDb
            .prepare('INSERT INTO brain_page_edges (from_id, to_id, edge_type, weight) VALUES (?, ?, ?, ?)')
...
//# sourceMappingURL=brain-pageindex.test.js.map