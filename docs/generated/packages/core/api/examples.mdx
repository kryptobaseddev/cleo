...
[View in API reference](/packages/core/api/functions#getcleoglobalrecipesdir)
...
[View in API reference](/packages/core/api/functions#getcleoglobaljustfilepath)
...
[View in API reference](/packages/core/api/functions#getcleopiextensionsdir)
...
[View in API reference](/packages/core/api/functions#getcleocantworkflowsdir)
...
[View in API reference](/packages/core/api/functions#getcleoglobalagentsdir)
...
[View in API reference](/packages/core/api/functions#buildstageguidance)
...
[View in API reference](/packages/core/api/functions#formatstageguidance)
...
[View in API reference](/packages/core/api/functions#ensurecleooshub)
...
[View in API reference](/packages/core/api/functions#classifyproject)
