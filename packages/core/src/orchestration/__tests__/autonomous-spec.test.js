...
describe('CONT-001: Token resolution', () => {
    it('resolveTokens resolves all known tokens', () => {
        const { resolved, unresolved } = resolveTokens('Task: {{TASK_ID}} Epic: {{EPIC_ID}} Date: {{DATE}}', { TASK_ID: 'T002', EPIC_ID: 'T001', DATE: '2026-01-01' });
...
//# sourceMappingURL=autonomous-spec.test.js.map