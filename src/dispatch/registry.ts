...
export const OPERATIONS: OperationDef[] = [
  ...
  },
  {
    ...
    requiredParams: [],
    params: [
      { name: 'status', type: 'string', required: false, description: 'Filter jobs by status' },
      { name: 'limit', type: 'number', required: false, description: 'Maximum jobs to return' },
  ...
  },
  {
    gateway: 'query',
    domain: 'admin',
    operation: 'token.summary',
    description: 'Summarize provider-aware token telemetry from token_usage table',
    tier: 2,
    idempotent: true,
    sessionRequired: false,
    requiredParams: [],
  },
  {
    ...
    description: 'List provider-aware token telemetry records with filters',
    tier: 2,
    idempotent: true,
    sessionRequired: false,
    requiredParams: [],
  ...
  },
  {
    gateway: 'query',
    domain: 'admin',
    operation: 'token.show',
    description: 'Show a single provider-aware token telemetry record',
    tier: 2,
    idempotent: true,
    sessionRequired: false,
  ...
  },
  {
    gateway: 'mutate',
    domain: 'admin',
    operation: 'token.record',
    description: 'Record a provider-aware token telemetry exchange',
    tier: 2,
    idempotent: false,
    sessionRequired: false,
    requiredParams: [],
  },
  {
    ...
    description: 'Delete a provider-aware token telemetry record',
    tier: 2,
    idempotent: false,
    sessionRequired: false,
    requiredParams: ['tokenId'],
  },
  {
    gateway: 'mutate',
    domain: 'admin',
    operation: 'token.clear',
    description: 'Clear provider-aware token telemetry records by filter',
    tier: 2,
    idempotent: false,
    sessionRequired: false,
    requiredParams: [],
