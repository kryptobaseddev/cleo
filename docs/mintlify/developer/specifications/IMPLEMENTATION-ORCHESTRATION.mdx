...
description: "7-agent implementation workflow with cyclical validation rounds through Planner, Coder, Testing, QA, Cleanup, Security, and Docs agents."
icon: "file-code"
---
...
# 3. Analyze tasks and auto-select active task
ct analyze --auto-focus

# 4. Get active task details
ct current --json
```
...
### On Activation
```bash
# Verify task is started and active
ct current --json
