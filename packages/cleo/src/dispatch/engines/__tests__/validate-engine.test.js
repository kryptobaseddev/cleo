...
import { validateComplianceRecord, validateComplianceSummary, validateComplianceViolations, validateManifest as validateManifestOp, validateOutput, validateTestStatus, } from '../validate-engine.js';
...
function writeCompliance(entries) {
...
describe('Validate Engine', () => {
    ...
    describe('validateManifest', () => {
        it('should validate well-formed manifest', () => {
            ...
            expect(result.data.validEntries).toBe(1);
        });
        it('should detect invalid entries', () => {
            ...
            expect(result.data.invalidEntries).toBe(1);
        });
    ...
    describe('validateOutput', () => {
        it('should validate output file', () => {
            ...
            writeFileSync(join(TEST_ROOT, 'out', 'test.md'), '# Test Output\n\n## Summary\n\nThis is a test output for T001.\n', 'utf-8');
...
//# sourceMappingURL=validate-engine.test.js.map