...
import { checkAllSkillUpdates, checkSkillUpdate, getTrackedSkills, recordSkillInstall, removeSkillFromLock, } from "../../src/core/skills/lock.js";
const mockLockFile = (overrides = {}) => ({
    version: 1,
    skills: {},
    mcpServers: {},
    ...overrides,
});
const mockSkillEntry = (overrides = {}) => ({
    name: "test-skill",
...
describe("skills lock", () => {
    ...
    describe("recordSkillInstall", () => {
        it("creates new skill entry in lock file", async () => {
            ...
            await recordSkillInstall("my-skill", "my-skill", "owner/repo", "github", ["claude-code"], "/path/to/skill", true);
        ...
        it("updates existing skill entry", async () => {
            ...
            await recordSkillInstall("existing-skill", "existing-skill", "owner/repo", "github", ["cursor"], "/new/path", false, "/project", "def789");
        ...
        it("merges agents without duplicates", async () => {
            ...
            await recordSkillInstall("my-skill", "my-skill", "owner/repo", "github", ["cursor", "windsurf"], "/path", true);
        ...
        it("preserves existing source if not provided", async () => {
            ...
            await recordSkillInstall("my-skill", "my-skill", "new/source", "gitlab", ["claude-code"], "/path", true);
        ...
        it("stores project directory for project-scoped installs", async () => {
            ...
            await recordSkillInstall("project-skill", "project-skill", "owner/repo", "github", ["claude-code"], "/path/to/skill", false, "/my/project");
        ...
        it("stores version when provided", async () => {
            ...
            await recordSkillInstall("versioned-skill", "versioned-skill", "owner/repo", "github", ["claude-code"], "/path", true, undefined, "v1.2.3");
        ...
        it("updates updatedAt timestamp on each call", async () => {
            ...
            await recordSkillInstall("my-skill", "my-skill", "owner/repo", "github", ["claude-code"], "/path", true);
...
//# sourceMappingURL=skills-lock.test.js.map