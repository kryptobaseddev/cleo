...
### DHQ-059 — The workgraph silently accumulates ORPHANS: `cleo add` permits parentless creation, cancel/archive never cascades, and no invariant/doctor/CI gate enforces containment
