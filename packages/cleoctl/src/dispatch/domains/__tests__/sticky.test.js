...
describe('Sticky Domain (T5282)', () => {
    ...
    describe('sticky.add (mutate)', () => {
        it('should be registered as a mutate operation', () => {
            const addOp = OPERATIONS.find((o) => o.domain === 'sticky' && o.operation === 'add' && o.gateway === 'mutate');
            expect(addOp).toBeDefined();
        });
    });
    describe('sticky.list (query)', () => {
        it('should be registered as a query operation', () => {
            const listOp = OPERATIONS.find((o) => o.domain === 'sticky' && o.operation === 'list' && o.gateway === 'query');
            expect(listOp).toBeDefined();
        });
    });
    describe('sticky.show (query)', () => {
        it('should be registered as a query operation', () => {
            const showOp = OPERATIONS.find((o) => o.domain === 'sticky' && o.operation === 'show' && o.gateway === 'query');
            expect(showOp).toBeDefined();
        });
    });
    describe('sticky.convert (mutate)', () => {
        it('should be registered as a mutate operation', () => {
            const convertOp = OPERATIONS.find((o) => o.domain === 'sticky' && o.operation === 'convert' && o.gateway === 'mutate');
            expect(convertOp).toBeDefined();
        });
    });
    describe('sticky.archive (mutate)', () => {
        it('should be registered as a mutate operation', () => {
            const archiveOp = OPERATIONS.find((o) => o.domain === 'sticky' && o.operation === 'archive' && o.gateway === 'mutate');
...
//# sourceMappingURL=sticky.test.js.map