 ...
 */
export async function upsertTask(db, row, archiveFields) {
 ...
 */
export async function updateDependencies(db, taskId, depends, validIds) {
 ...
 */
export async function batchUpdateDependencies(db, tasks, validIds) {
    if (tasks.length === 0)
        return;
 ...
 */
export async function loadDependenciesForTasks(db, tasks, validationIds) {
    if (tasks.length === 0)
        return;
