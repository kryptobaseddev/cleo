...
description: "Implementation details for the LLM-agent-first task decomposition system with atomicity scoring and DAG validation"
icon: "code"
---
...
```bash
# 1. Start session and activate task
cleo session start
cleo start <phase-task-id>
