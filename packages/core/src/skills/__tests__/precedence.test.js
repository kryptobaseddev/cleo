...
import { determineInstallationTargets, getProvidersWithPrecedence, getSkillsMapWithPrecedence, resolveSkillPathsForProvider, supportsAgentsPath, } from '../precedence-integration.js';
// Mock CAAMP
...
describe('Skills Precedence Integration', () => {
    ...
    describe('resolveSkillPathsForProvider', () => {
        ...
        it('should throw for unknown provider', async () => {
            ...
            await expect(resolveSkillPathsForProvider('unknown', 'global')).rejects.toThrow('Provider unknown not found');
        });
    ...
    describe('getSkillsMapWithPrecedence', () => {
        it('should return skills map from CAAMP', async () => {
            ...
            vi.mocked(buildSkillsMap).mockReturnValue(mockMap);
...
//# sourceMappingURL=precedence.test.js.map