...
describe('getConfigValue', () => {
    ...
    it('returns default value with source tracking', async () => {
        const projectDir = join(tempDir, 'project');
        process.env['CLEO_DIR'] = join(projectDir, '.cleo');
        const result = await getConfigValue('hierarchy.maxDepth', projectDir);
    ...
    it('returns env value with source tracking', async () => {
        ...
        const result = await getConfigValue('output.defaultFormat', projectDir);
    ...
    it('returns project config value with source tracking', async () => {
        ...
        process.env['CLEO_DIR'] = cleoDir;
        const result = await getConfigValue('hierarchy.maxDepth', join(tempDir, 'project'));
