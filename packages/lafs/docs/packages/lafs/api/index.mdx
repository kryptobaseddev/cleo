...
| [`wrapMCPResult()`](/packages/lafs/api/functions#wrapmcpresult)                                       | function | Wrap an MCP tool result in a LAFS envelope.                                      |
| [`createAdapterErrorEnvelope()`](/packages/lafs/api/functions#createadaptererrorenvelope)             | function | Create a LAFS error envelope for MCP adapter errors.                             |
| [`isTextContent()`](/packages/lafs/api/functions#istextcontent)                                       | function | Type guard to check if content is MCP TextContent.                               |
| [`parseMCPTextContent()`](/packages/lafs/api/functions#parsemcptextcontent)                           | function | Parse MCP text content as JSON if possible.                                      |
...
| [`StructuredValidationError`](/packages/lafs/api/types#structuredvalidationerror)                         | interface | Structured representation of a single validation error from AJV.                  |
...
| [`mcpAdapter.ts`](/packages/lafs/api/functions#mcpadapterts)                             | file     |                                                                                  |
