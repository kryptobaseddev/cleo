...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
5. Load context via:
   ```bash
   node "/tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" init quick
   ```
...
Execute the quick workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/quick.md end-to-end.
