...
```bash
AUDITOR_MODEL=$(node "/tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /tmp/pomodoro-bench/gsd/.claude/agents/gsd-eval-auditor.md for instructions.
