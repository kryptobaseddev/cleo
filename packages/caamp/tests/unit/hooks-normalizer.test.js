...
import { CANONICAL_HOOK_EVENTS, HOOK_CATEGORIES, toNative, toCanonical, toNativeBatch, supportsHook, getHookSupport, getSupportedEvents, getUnsupportedEvents, getProvidersForEvent, getCommonEvents, getProviderSummary, buildHookMatrix, getHookSystemType, getHookConfigPath, getProviderOnlyEvents, translateToAll, resolveNativeEvent, getHookMappingsVersion, getCanonicalEvent, getAllCanonicalEvents, getCanonicalEventsByCategory, getProviderHookProfile, getMappedProviderIds, resetHookMappings, } from "../../src/core/hooks/index.js";
describe("Hooks Normalizer", () => {
    ...
    describe("toNativeBatch", () => {
        it("translates multiple events for a provider", () => {
            const results = toNativeBatch(["SessionStart", "PreToolUse", "PreModel"], "gemini-cli");
        ...
        it("excludes unsupported events", () => {
            const results = toNativeBatch(["SessionStart", "PreModel"], "claude-code");
...
//# sourceMappingURL=hooks-normalizer.test.js.map