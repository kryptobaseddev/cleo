...
import { nexusBlockers, nexusCriticalPath, nexusDepsQuery, nexusDiscover, nexusGraph, nexusInitialize, nexusListProjects, nexusOrphans, nexusReconcileProject, nexusRegisterProject, nexusResolve, nexusSearch, nexusSetPermission, nexusShareSnapshotExport, nexusShareSnapshotImport, nexusShareStatus, nexusShowProject, nexusStatus, nexusSyncProject, nexusTransferExecute, nexusTransferPreview, nexusUnregisterProject, } from '../../engines/nexus-engine.js';
...
describe('NexusHandler', () => {
    ...
    describe('mutate: share.snapshot.import', () => {
        ...
        it('imports snapshot from input path', async () => {
            ...
            expect(result.success).toBe(true);
            expect(nexusShareSnapshotImport).toHaveBeenCalledWith('/mock/project', '/path/to/snapshot.json');
        });
    });
