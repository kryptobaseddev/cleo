/**
 * Tests for the shared agent-lifecycle LANE RESOLVER (the SSoT in
 * `@cleocode/core/tasks`, consumed by both the Studio Kanban board (T11926) and
 * the `cleo tui` Kanban home view (T11934)).
 *
 * Covers every lane plus the documented precedence ladder
 * (`cancelled > done > blocked > review > running > ready > backlog`) and the
 * dependency-eligibility edge cases. Pure function, node environment, no Svelte
 * mount.
 *
 * @task T11934 — lane model lifted to core
 * @task T11926 — original Studio resolver behaviour, preserved here verbatim
 * @epic T11916
 */
...
describe('AGENT_LIFECYCLE_LANES taxonomy (T11934)', () => {
...
describe('resolveAgentLifecycleLane — terminal lanes (T11934)', () => {
...
describe('resolveAgentLifecycleLane — blocked lane (T11934)', () => {
...
describe('resolveAgentLifecycleLane — review lane (T11934)', () => {
...
describe('resolveAgentLifecycleLane — running lane (T11934)', () => {
...
describe('resolveAgentLifecycleLane — ready lane (T11934)', () => {
...
describe('resolveAgentLifecycleLane — backlog lane (T11934)', () => {
...
describe('resolveAgentLifecycleLane — precedence ladder (T11934)', () => {
