...
acceptance:
  ["Email regex validates format", "Error message displays on invalid input"]
```
...
```json
{
  ...
  "edges": [
    ...
    },
    {
      ...
      "to": "T004",
      "type": "semantic",
      "evidence": "Tests require implementation"
    },
    {
      "from": "T003",
      "to": "T004",
...
| `E_DECOMPOSE_SIBLINGS`    | 12        | Generated tasks exceeded the configured sibling limit |
      ...
      "options": [
        {
          "id": "A",
          "label": "Google only",
          "implications": "Simpler, ~2 tasks"
        },
        {
          "id": "B",
          "label": "Google + GitHub",
          "implications": "Moderate, ~4 tasks"
        },
        {
          "id": "C",
          "label": "All major (Google, GitHub, Microsoft, Apple)",
          "implications": "Complex, ~8 tasks"
        }
      ]
    }
  ],
