...
```typescript
(filters?: { status?: "cancelled" | "active" | "pending" | "blocked" | "done" | "archived" | ("cancelled" | "active" | "pending" | "blocked" | "done" | "archived")[] | undefined; parentId?: string | undefined; } | undefined) => Promise<...>
```
...
```typescript
(memoryType: "decision" | "pattern" | "learning" | "observation", memoryId: string) => Promise<{ taskId: string; createdAt: string; linkType: "produced_by" | "applies_to" | "informed_by" | "contradicts"; memoryType: "decision" | ... 2 more ... | "observation"; memoryId: string; }[]>
```

### getLinksForTask()

```typescript
(taskId: string) => Promise<{ taskId: string; createdAt: string; linkType: "produced_by" | "applies_to" | "informed_by" | "contradicts"; memoryType: "decision" | "pattern" | "learning" | "observation"; memoryId: string; }[]>
```
...
```typescript
(row: { id: string; content: string; status?: "active" | "archived" | "converted" | undefined; createdAt?: string | undefined; updatedAt?: string | null | undefined; priority?: "high" | "medium" | "low" | null | undefined; sourceType?: string | ... 1 more ... | undefined; tagsJson?: string | ... 1 more ... | undefin...
```

### getStickyNote()

```typescript
(id: string) => Promise<{ id: string; status: "active" | "archived" | "converted"; createdAt: string; updatedAt: string | null; priority: "high" | "medium" | "low" | null; content: string; sourceType: string | null; tagsJson: string | null; convertedToJson: string | null; color: "yellow" | ... 4 more ... | null; } |...
```
...
```typescript
(id: string, updates: Partial<{ id: string; content: string; status?: "active" | "archived" | "converted" | undefined; createdAt?: string | undefined; updatedAt?: string | null | undefined; priority?: "high" | ... 3 more ... | undefined; sourceType?: string | ... 1 more ... | undefined; tagsJson?: string | ... 1 mor...
```
...
```typescript
(node: { id: string; nodeType: "task" | "file" | "doc" | "concept"; label: string; metadataJson?: string | null | undefined; createdAt?: string | undefined; }) => Promise<{ id: string; metadataJson: string | null; createdAt: string; nodeType: "task" | ... 2 more ... | "concept"; label: string; }>
```

### getPageNode()

```typescript
(id: string) => Promise<{ id: string; metadataJson: string | null; createdAt: string; nodeType: "task" | "file" | "doc" | "concept"; label: string; } | null>
```

### findPageNodes()

```typescript
(params?: { nodeType?: "task" | "file" | "doc" | "concept" | undefined; limit?: number | undefined; }) => Promise<{ id: string; metadataJson: string | null; createdAt: string; nodeType: "task" | "file" | "doc" | "concept"; label: string; }[]>
```
...
```typescript
(nodeId: string, edgeType?: "depends_on" | "implements" | "relates_to" | "documents" | undefined) => Promise<{ id: string; metadataJson: string | null; createdAt: string; nodeType: "task" | "file" | "doc" | "concept"; label: string; }[]>
```
...
|------|------|-------------|
| `taskId` | `string` | The task ID |
| `reason` | `: string \| undefined` | Optional completion reason, stored in the final stage's notes |
...
| Name | Type | Description |
|------|------|-------------|
| `agentType` | `: "custom" \| "orchestrator" \| "executor" \| "researcher" \| "architect" \| "validator" \| "documentor" \| undefined` | Optional type filter |
| `cwd` | `: string \| undefined` | Working directory |
...
| `policy` | `: Partial&lt;RetryPolicy&gt; \| undefined` | Retry policy (uses DEFAULT_RETRY_POLICY if not provided) |
...
| `accessor` | `: DataAccessor \| undefined` | DataAccessor instance (or auto-created from cwd) |
| `cwd` | `: string \| undefined` | Working directory (used if accessor is not provided) |
...
| `options` | `: PatternExtractionOptions \| undefined` | Extraction options (min frequency, confidence, limit) |
...
| Name | Type | Description |
|------|------|-------------|
| `patternId` | `string` | The brain_patterns ID to update |
...
| Name | Type | Description |
|------|------|-------------|
| `` | `: \{ dryRun?: boolean \| undefined; includeGlobal?: boolean \| undefined; autoMigrate?: boolean \| undefined; forceDetect?: boolean \| undefined; mapCodebase?: boolean \| undefined; projectName?: string \| undefined; cwd?: string \| undefined; \}` | options.dryRun  Preview changes without applying |
| `` | `: \{ dryRun?: boolean \| undefined; includeGlobal?: boolean \| undefined; autoMigrate?: boolean \| undefined; forceDetect?: boolean \| undefined; mapCodebase?: boolean \| undefined; projectName?: string \| undefined; cwd?: string \| undefined; \}` | options.includeGlobal  Also check global ~/.cleo |
| `` | `: \{ dryRun?: boolean \| undefined; includeGlobal?: boolean \| undefined; autoMigrate?: boolean \| undefined; forceDetect?: boolean \| undefined; mapCodebase?: boolean \| undefined; projectName?: string \| undefined; cwd?: string \| undefined; \}` | options.autoMigrate  Auto-migrate storage if needed (default: true) |
| `` | `: \{ dryRun?: boolean \| undefined; includeGlobal?: boolean \| undefined; autoMigrate?: boolean \| undefined; forceDetect?: boolean \| undefined; mapCodebase?: boolean \| undefined; projectName?: string \| undefined; cwd?: string \| undefined; \}` | options.forceDetect  Force re-detection of project type (ignore staleness) |
| `` | `: \{ dryRun?: boolean \| undefined; includeGlobal?: boolean \| undefined; autoMigrate?: boolean \| undefined; forceDetect?: boolean \| undefined; mapCodebase?: boolean \| undefined; projectName?: string \| undefined; cwd?: string \| undefined; \}` | options.mapCodebase  Run full codebase analysis and store to brain.db |
| `` | `: \{ dryRun?: boolean \| undefined; includeGlobal?: boolean \| undefined; autoMigrate?: boolean \| undefined; forceDetect?: boolean \| undefined; mapCodebase?: boolean \| undefined; projectName?: string \| undefined; cwd?: string \| undefined; \}` | options.projectName  Update project name in project-info and nexus |
| `` | `: \{ dryRun?: boolean \| undefined; includeGlobal?: boolean \| undefined; autoMigrate?: boolean \| undefined; forceDetect?: boolean \| undefined; mapCodebase?: boolean \| undefined; projectName?: string \| undefined; cwd?: string \| undefined; \}` | options.cwd  Project directory override |
