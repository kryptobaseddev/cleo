...
<Update label="January 2026" description="v0.57.7" tags={["Fix", "Feature", "CLI"]}>
## CLI dispatcher
...
[View full release notes](https://github.com/kryptobaseddev/cleo/releases/tag/v0.57.7)
</Update>

<Update label="January 2026" description="v0.57.6" tags={["Fix", "Feature", "Installer"]}>
## Installer
...
[View full release notes](https://github.com/kryptobaseddev/cleo/releases/tag/v0.57.6)
</Update>

<Update label="January 2026" description="v0.57.5" tags={["Core"]}>
## v0.57.5 Release
...
[View full release notes](https://github.com/kryptobaseddev/cleo/releases/tag/v0.57.5)
</Update>
