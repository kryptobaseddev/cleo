...
import { allEpicChildrenVerified, checkCircularValidation, computePassed, getDownstreamGates, getGateIndex, getGateOrder, getMissingGates, getVerificationStatus, incrementRound, initVerification, isValidAgentName, isValidGateName, isVerificationComplete, logFailure, resetDownstreamGates, setVerificationPassed, shouldRequireVerification, updateGate, } from '../verification.js';
// ============================================================================
// Initialization
// ============================================================================
...
describe('updateGate', () => {
    ...
    it('throws for invalid gate', () => {
        const v = initVerification();
        expect(() => updateGate(v, 'invalid', true)).toThrow();
    });
