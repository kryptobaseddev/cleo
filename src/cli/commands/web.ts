...
// TODO T4894: operation 'web' not yet in registry — no dispatch equivalent.\n// Leave bypass; web command requires process spawn/PID management not suitable for dispatch.
