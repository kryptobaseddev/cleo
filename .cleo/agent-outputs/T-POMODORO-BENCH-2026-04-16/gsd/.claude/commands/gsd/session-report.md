...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
