...
**Default: unlimited (`0`) children per parent** (configurable)
...
1. Query current phase active task
...
## Part 12: Active Task Integration

### 12.1 Active Task in Hierarchy

When starting an epic, the system MUST:

- Show epic context with child summary
- Display children status counts
- Show visual hierarchy of children

When starting a child task, the system MUST:
...
- Prefer tasks in currently active epic
