 ...
 */
export declare function createTestEpic(
  context: IntegrationTestContext,
  title: string,
  description: string,
): Promise<string>;
 ...
 */
export declare function startTestSession(
  context: IntegrationTestContext,
  epicId: string,
): Promise<void>;
/**
 ...
 */
export declare function taskExists(
  executor: WrappedExecutor,
  taskId: string,
  cwd?: string,
): Promise<boolean>;
 ...
 */
export declare function waitForCondition(
 ...
 */
export declare function getAuditLogEntries(
