...
export const BRAIN_CONFIDENCE_LEVELS = ['low', 'medium', 'high'];
/** Outcome types for decision tracking. */
export const BRAIN_OUTCOME_TYPES = ['success', 'failure', 'mixed', 'pending'];
...
export const BRAIN_IMPACT_LEVELS = ['low', 'medium', 'high'];
...
export const BRAIN_MEMORY_TYPES = ['decision', 'pattern', 'learning', 'observation'];
/** Sticky note status values. */
export const BRAIN_STICKY_STATUSES = ['active', 'converted', 'archived'];
/** Sticky note colors. */
export const BRAIN_STICKY_COLORS = ['yellow', 'blue', 'green', 'red', 'purple'];
/** Sticky note priority levels. */
export const BRAIN_STICKY_PRIORITIES = ['low', 'medium', 'high'];
...
export const BRAIN_NODE_TYPES = ['task', 'doc', 'file', 'concept'];
/** Edge types for PageIndex graph. */
export const BRAIN_EDGE_TYPES = ['depends_on', 'relates_to', 'implements', 'documents'];
