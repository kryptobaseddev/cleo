...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/new-workspace.md
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
