...
See /tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/discovery.md
...
Use /tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/discovery.md.
