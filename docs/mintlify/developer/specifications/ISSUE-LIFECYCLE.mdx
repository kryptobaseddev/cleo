...
description: "External issue tracking via origin field with triage workflow, severity classification, and verification protocol for bugs and features."
icon: "file-code"
---
...
#   T502 [minor] Active task not restored on resume
#
# Fixed Issues: 3
