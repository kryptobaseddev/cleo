...
- **MCP is PRIMARY**: 2 tools, 258 operations across 10 canonical domains (~1,800 tokens)
...
- `docs/specs/CLEO-OPERATION-CONSTITUTION.md` - All 258 MCP operations mapped to CLI equivalents (supersedes CLEO-OPERATIONS-REFERENCE.md)
