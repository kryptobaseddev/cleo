...
describe('ProtocolEnforcer', () => {
    ...
    describe('Specification Protocol', () => {
        it('should pass valid specification manifest', async () => {
            ...
            const result = await enforcer.validateProtocol(ProtocolType.SPECIFICATION, manifest, additionalData);
            expect(result.valid).toBe(true);
        });
    ...
    describe('Implementation Protocol', () => {
        it('should pass without new functions', async () => {
            ...
            const result = await enforcer.validateProtocol(ProtocolType.IMPLEMENTATION, manifest, additionalData);
            expect(result.valid).toBe(true);
        });
    ...
    describe('Violation Recording', () => {
        it('should record violations', () => {
            enforcer.recordViolation(ProtocolType.RESEARCH, [
                {
...
//# sourceMappingURL=protocol-enforcement.test.js.map