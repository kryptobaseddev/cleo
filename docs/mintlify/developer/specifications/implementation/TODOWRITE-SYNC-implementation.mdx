---
title: "TodoWrite Sync Implementation"
description: "Implementation details for bidirectional TodoWrite integration with task injection and extraction"
icon: "code"
---
...
|-----------|--------|---------|-------|
| `sync.sh` orchestrator | COMPLETE | v0.14.0 | Subcommand routing working |
| `inject.sh` script | COMPLETE | v0.14.0 | 346 lines, tiered selection |
| `extract.sh` script | COMPLETE | v0.14.0 | 403 lines, change detection |
...
|---------|--------|----------|-------|
| Tiered task selection | COMPLETE | 3.1 | Active task → deps → priority |
...
| Script | Status | Notes |
|--------|--------|-------|
| `update.sh --quiet` | PENDING | Not implemented |
| `complete.sh --quiet` | PENDING | Not implemented |
...
- [x] T234: Implement inject.sh (completed 2025-12-15)
- [x] T235: Implement extract.sh (completed 2025-12-15)
- [x] T236: Implement sync.sh orchestrator (completed 2025-12-15)
...
- [ ] Add --quiet flags to update.sh, complete.sh, focus.sh, session.sh
...
| File | Lines | Purpose |
|------|-------|---------|
| `scripts/sync.sh` | 190 | Subcommand orchestrator |
| `scripts/inject.sh` | 346 | Task → TodoWrite transformation |
| `scripts/extract.sh` | 403 | TodoWrite → cleo merge |
...
| `scripts/update.sh` | Add --quiet flag |
| `scripts/complete.sh` | Add --quiet flag |
