...
description: "Multi-agent work attribution protocol"
icon: "code-merge"
---

{/* AUTO-GENERATED from protocols/contribution.md - DO NOT EDIT DIRECTLY */}
{/* Source of truth: /protocols/contribution.md */}
