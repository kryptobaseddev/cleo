import { o as onDestroy } from './index-server-D_hhbQIS.js';
import { a7 as head, a5 as escape_html, a1 as ensure_array_like, a3 as attr_class, a8 as attr_style, a2 as attr, a9 as stringify, P as derived } from './dev-BIJYOMms.js';
import 'graphology';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]-->  <div${attr_class("lb-body svelte-prt765", void 0, { "has-panel": sideError !== null })}><div class="lb-canvas svelte-prt765">`);
...
//# sourceMappingURL=_page.svelte-7XEZbqk4.js.map
