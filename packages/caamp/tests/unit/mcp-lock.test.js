...
import { getLastSelectedAgents, getTrackedMcpServers, recordMcpInstall, removeMcpFromLock, saveLastSelectedAgents, } from "../../src/core/mcp/lock.js";
...
describe("mcp lock", () => {
    ...
    it("propagates update failures when recording installs", async () => {
        ...
        await expect(recordMcpInstall("filesystem", "source", "package", ["claude-code"], true)).rejects.toThrow("write failed");
    });
});
//# sourceMappingURL=mcp-lock.test.js.map