...
import { findManifestEntry, logRealCompliance, validateAndLog, validateManifestEntry, } from '../manifest.js';
// ============================================================================
// Helpers
// ============================================================================
function makeRoot() {
...
function makeManifestFile(dir, entries) {
...
describe('logRealCompliance', () => {
    ...
    it('creates metrics directory if it does not exist', async () => {
        ...
        const result = { valid: true, score: 75, pass: true, violations: [] };
