...
import { _getAgentPerformanceHistoryWithAccessor, _getSelfHealingSuggestionsWithAccessor, _recordAgentExecutionWithAccessor, _recordFailurePatternWithAccessor, _storeHealingStrategyWithAccessor, getAgentPerformanceHistory, getSelfHealingSuggestions, processAgentLifecycleEvent, recordAgentExecution, recordFailurePattern, storeHealingStrategy, } from '../execution-learning.js';
// ============================================================================
// Test setup
// ============================================================================
describe('Agent Execution Learning', () => {
    ...
    describe('recordAgentExecution', () => {
        ...
        it('embeds structured metadata in alternativesJson', async () => {
            ...
            const row = await recordAgentExecution(event, tempDir);
            expect(row).not.toBeNull();
            const meta = JSON.parse(row.alternativesJson ?? '{}');
    ...
    describe('getAgentPerformanceHistory', () => {
        ...
        it('aggregates successes and failures by (agentType, taskType)', async () => {
            ...
            const executorSummary = summaries.find((s) => s.agentType === 'executor' && s.taskType === 'task');
            ...
            const researcherSummary = summaries.find((s) => s.agentType === 'researcher' && s.taskType === 'epic');
        ...
        it('filters by agentType when specified', async () => {
            ...
            const summaries = await _getAgentPerformanceHistoryWithAccessor({ agentType: 'executor' }, brain);
    ...
    describe('storeHealingStrategy', () => {
        ...
        it('stores a change observation with healing narrative', async () => {
            ...
            const obs = await _storeHealingStrategyWithAccessor(event, 'Switch to validator agent', brain);
...
//# sourceMappingURL=execution-learning.test.js.map