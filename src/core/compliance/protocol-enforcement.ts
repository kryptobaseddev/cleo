 ...
 */
const PROTOCOL_EXIT_CODES: Record<ProtocolType, ProtocolExitCode> = {
  [ProtocolType.RESEARCH]: ProtocolExitCode.E_PROTOCOL_RESEARCH,
  [ProtocolType.CONSENSUS]: ProtocolExitCode.E_PROTOCOL_CONSENSUS,
  [ProtocolType.SPECIFICATION]: ProtocolExitCode.E_PROTOCOL_SPECIFICATION,
  [ProtocolType.DECOMPOSITION]: ProtocolExitCode.E_PROTOCOL_DECOMPOSITION,
  [ProtocolType.IMPLEMENTATION]: ProtocolExitCode.E_PROTOCOL_IMPLEMENTATION,
  [ProtocolType.CONTRIBUTION]: ProtocolExitCode.E_PROTOCOL_CONTRIBUTION,
  [ProtocolType.RELEASE]: ProtocolExitCode.E_PROTOCOL_RELEASE,
  [ProtocolType.VALIDATION]: ProtocolExitCode.E_PROTOCOL_VALIDATION,
  [ProtocolType.TESTING]: ProtocolExitCode.E_TESTS_SKIPPED,
};
...
export class ProtocolEnforcer {
   ...
   */
  private requiresProtocolValidation(request: ProtocolRequest): boolean {
   ...
   */
  private extractManifestEntry(response: ProtocolResponse): Record<string, unknown> | null {
