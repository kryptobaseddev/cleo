...
| [`readSyncState()`](/packages/core/api/index#readsyncstate) | function | Read sync session state for a provider. Returns null if no state file exists. |
| [`writeSyncState()`](/packages/core/api/index#writesyncstate) | function | Write sync session state for a provider. |
| [`clearSyncState()`](/packages/core/api/index#clearsyncstate) | function | Clear (delete) sync session state for a provider. |
...
| [`injectTasks()`](/packages/core/api/index#injecttasks) | function | Inject tasks into TodoWrite format. |
...
| [`analyzeChanges()`](/packages/core/api/index#analyzechanges) | function | Analyze TodoWrite state and detect changes against injected task IDs. |
| [`mergeTodoWriteState()`](/packages/core/api/index#mergetodowritestate) | function | Merge TodoWrite state back to CLEO tasks. |
...
| [`getSyncStatus()`](/packages/core/api/index#getsyncstatus) | function | Get current sync status.  T5326 |
| [`clearSyncState()`](/packages/core/api/index#clearsyncstate) | function | Clear sync state.  T5326 |
...
| [`TodoWriteItem`](/packages/core/api/index#todowriteitem) | interface |  |
| [`TodoWriteState`](/packages/core/api/index#todowritestate) | interface |  |
| [`SyncSessionState`](/packages/core/api/index#syncsessionstate) | interface |  |
| [`ChangeSet`](/packages/core/api/index#changeset) | interface |  |
| [`TodoWriteMergeOptions`](/packages/core/api/index#todowritemergeoptions) | interface |  |
| [`TodoWriteMergeResult`](/packages/core/api/index#todowritemergeresult) | interface |  |
...
| [`SyncStatusResult`](/packages/core/api/index#syncstatusresult) | interface | Result for sync status operation. |
| [`SyncClearResult`](/packages/core/api/index#syncclearresult) | interface | Result for sync clear operation. |
