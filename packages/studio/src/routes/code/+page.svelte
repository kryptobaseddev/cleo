...
<svelte:head>
  <title>Code — CLEO Studio</title>
</svelte:head>

<div class="nexus-macro">
  <div class="page-header">
    <div class="header-left">
      <div class="view-icon nexus-icon">C</div>
      <div>
        <h1 class="view-title">Code Intelligence</h1>
    ...
    <div class="header-right">
      <a href="/brain?scope=nexus" class="canvas-pill">Open in Canvas &rarr;</a>
    ...
    <div class="community-list">
      ...
      <div class="community-grid">
        {#each data.macroNodes.slice(0, 24) as community}
          <a
            href="/code/community/{encodeURIComponent(community.id)}"
