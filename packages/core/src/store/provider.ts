...
import type { AddTaskOptions, AddTaskResult } from '../tasks/add.js';
import type { AnalysisResult } from '../tasks/analyze.js';
import type { ArchiveTasksOptions, ArchiveTasksResult } from '../tasks/archive.js';
import type { CompleteTaskOptions, CompleteTaskResult } from '../tasks/complete.js';
import type { DeleteTaskOptions, DeleteTaskResult } from '../tasks/delete.js';
...
> {
  ...
  const { deleteTask } = await import('../tasks/delete.js');
  const { findTasks } = await import('../tasks/find.js');
  const { listTasks } = await import('../tasks/list.js');
  const { archiveTasks } = await import('../tasks/archive.js');
  const labels = await import('../tasks/labels.js');
  const relates = await import('../tasks/relates.js');
  const { analyzeTaskPriority } = await import('../tasks/analyze.js');
