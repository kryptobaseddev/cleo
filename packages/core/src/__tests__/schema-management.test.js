...
import { checkGlobalSchemas, checkSchemaStaleness, cleanProjectSchemas, ensureGlobalSchemas, getSchemaVersion, listInstalledSchemas, resolveSchemaPath, } from '../schema-management.js';
// Helper: create a minimal schema JSON with a version
function makeSchema(version, useMeta = false) {
    if (useMeta) {
...
describe('schema-management', () => {
    ...
    describe('getSchemaVersion', () => {
        ...
        it('returns null for schema without a version field', () => {
            mkdirSync(mockGlobalSchemasDir, { recursive: true });
            writeFileSync(join(mockGlobalSchemasDir, 'bare.schema.json'), JSON.stringify({ type: 'object' }));
...
//# sourceMappingURL=schema-management.test.js.map