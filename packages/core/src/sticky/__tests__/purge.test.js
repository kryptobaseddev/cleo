...
describe('purgeSticky', () => {
    ...
    it('should permanently delete an active sticky note', async () => {
        ...
        const sticky = await addSticky({ content: 'Test sticky to purge', tags: ['test'] }, projectRoot);
        // Verify it exists
    ...
    it('should permanently delete an archived sticky note', async () => {
        ...
        const sticky = await addSticky({ content: 'Test archived sticky to purge', tags: ['test'] }, projectRoot);
