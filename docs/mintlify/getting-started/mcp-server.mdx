...
<Info>
The MCP Server covers **177 operations** (97 query + 80 mutate) across 10 canonical domains: tasks, session, memory, check, pipeline, orchestrate, tools, admin, nexus, and sharing.
</Info>
