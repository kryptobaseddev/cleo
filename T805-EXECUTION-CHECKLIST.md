...
### Step 1: Research
- [ ] **T1211**: Research existing ordering patterns
...
#### Step 5: Core Reorder
- [ ] **T1218**: Implement reorder command
...
- [ ] **T1221**: Handle position on reparent *(depends: T1218)*
...
- [ ] **T1217**: Implement Reorder Commands *(auto-completes when children done)*
...
#### Step 5: List Sort
- [ ] **T1223**: Add --sort position to list command
...
- [ ] **T1224**: Update tree command for position order *(depends: T1223)*
  - Modify `scripts/tree.sh`
  - Children ordered by position within parent
  - Add --ordered flag
  - Display position numbers [1], [2], [3] inline

- [ ] **T1225**: Add dependency-aware display formatting *(depends: T1223)*
...
- [ ] **T1222**: Update Display for Position Ordering *(auto-completes when children done)*

---

### Track C: Migration (T1226)

- [ ] **T1226**: Implement Position Migration *(depends: T1216)*
...
### Step 8: Unit Tests
- [ ] **T1228**: Unit tests for position shuffle logic
...
- [ ] **T1229**: Integration tests for reorder commands *(depends: T1228)*
...
- [ ] **T1230**: Update command documentation *(depends: T1229)*
...
- [ ] **T1227**: Add Tests and Documentation *(auto-completes when children done)*

---

## Phase 5: Epic Completion

- [ ] **T805**: Explicit Positional Ordering System *(auto-completes when all children done)*
