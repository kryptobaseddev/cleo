...
describe("coverage: github.ts cloneRepo cleanup error (line 46)", () => {
    ...
    it("cloneRepo with ref passes --branch flag", async () => {
        ...
        expect(result.localPath).toBe("/tmp/caamp-test-mock");
        expect(mockClone).toHaveBeenCalledWith("https://github.com/owner/repo.git", "/tmp/caamp-test-mock", ["--depth", "1", "--branch", "develop"]);
    });
...
describe("coverage: gitlab.ts cloneGitLabRepo cleanup error (line 40)", () => {
    ...
    it("cloneGitLabRepo with ref passes --branch flag", async () => {
        ...
        expect(mockClone).toHaveBeenCalledWith("https://gitlab.com/owner/repo.git", "/tmp/caamp-gl-test-mock", ["--depth", "1", "--branch", "develop"]);
    });
...
//# sourceMappingURL=coverage-clone-cleanup.test.js.map