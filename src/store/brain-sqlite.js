 ...
 */
export function resolveBrainMigrationsFolder() {
 ...
 * @task T5157
 */
function initializeBrainVec(nativeDb) {
    nativeDb
        .prepare('CREATE VIRTUAL TABLE IF NOT EXISTS brain_embeddings USING vec0(id TEXT PRIMARY KEY, embedding FLOAT[384])')
        .run();
}
/**
 * Check whether the sqlite-vec extension is loaded for the current brain.db.
 */
export function isBrainVecLoaded() {
    return _vecLoaded;
}
/**
 ...
 */
export function getBrainNativeDb() {
    return _nativeDb;
}
/**
 ...
 */
export { brainSchema };
//# sourceMappingURL=brain-sqlite.js.map