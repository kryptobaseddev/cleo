...
| [`toolsTodowriteStatus()`](/packages/cleo/api/functions#toolstodowritestatus) | function | Get TodoWrite sync status. |
| [`toolsTodowriteSync()`](/packages/cleo/api/functions#toolstodowritesync) | function | Trigger TodoWrite sync. |
| [`toolsTodowriteClear()`](/packages/cleo/api/functions#toolstodowriteclear) | function | Clear TodoWrite sync state. |
...
| [`registerExtractCommand()`](/packages/cleo/api/functions#registerextractcommand) | function | Register the extract command.  T4551 |
...
| [`registerSyncCommand()`](/packages/cleo/api/functions#registersynccommand) | function | Register the sync command.  T4551, T5326 |
