---
title: "Consensus Framework Implementation"
description: "Implementation details for multi-agent consensus validation and decision-making framework"
icon: "code"
---
...
**Phase 1 Output**: `docs/archive/specs-md/research/consensus-framework/standards-research-findings.md` (archived), `docs/archive/specs-md/research/consensus-framework/documentation-audit-findings.md` (archived)
...
- [x] Correct file paths (claudedocs/ vs docs/archive/specs-md/) → Genericized in v2.0.0
...
# 4. List output files
ls docs/archive/specs-md/research/ 2>/dev/null || echo "Research directory archived"
...
# 2. Start phase task
cleo start T184  # Phase 1
# OR
cleo start T189  # Phase 2
# OR
cleo start T195  # Phase 3
# OR
cleo start T199  # Phase 4

# 3. Update phase task to active
cleo update T184 --status active --notes "Starting Phase 1"

# 4. Read spec
cat docs/archive/specs-md/CONSENSUS-FRAMEWORK-SPEC.md
...
# ... do work ...
cleo update T185 --notes "DOC: docs/archive/specs-md/research/consensus-framework/standards-research-findings.md (archived)"
cleo complete T185
...
```
docs/archive/specs-md/research/consensus-framework/ (archived)
