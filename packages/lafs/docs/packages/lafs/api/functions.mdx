...
| Name        | Type             | Description                                   |
| ----------- | ---------------- | --------------------------------------------- |
| `mcpResult` | `CallToolResult` | The raw MCP CallToolResult                    |
| `operation` | `string`         | The operation name (tool name)                |
| `budget`    | `: number`       | Optional token budget for response truncation |
...
| `category`  | `: LAFSError["category"]` | Error category (defaults to `"INTERNAL"`)             |
...
| Name      | Type      | Description            |
| --------- | --------- | ---------------------- |
| `content` | `unknown` | Unknown value to check |
...
| Name      | Type          | Description              |
| --------- | ------------- | ------------------------ |
| `content` | `TextContent` | MCP TextContent to parse |
