...
export const ErrorCodes = {
  ...
  /** The skill security gate could not be loaded, so the install was refused (T12384). */
  SKILL_GATE_UNAVAILABLE: 'E_SKILL_GATE_UNAVAILABLE',
  FEDERATION_UNKNOWN_SOURCE_INTERACTIVE_REQUIRED:
