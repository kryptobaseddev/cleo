...
|-------------|-------------|
| OUT-001 | MUST write findings to `.cleo/agent-outputs/{DATE}_{TOPIC_SLUG}.md` |
| OUT-002 | MUST append ONE line to `.cleo/agent-outputs/MANIFEST.jsonl` |
...
| Before | After |
|--------|-------|
| `claudedocs/research-outputs/` | `.cleo/agent-outputs/` |
...
2. Set focus: `{{TASK_START_CMD}} {{TASK_ID}}`
...
mv .cleo/agent-outputs claudedocs/research-outputs
