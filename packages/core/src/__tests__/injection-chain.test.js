...
vi.mock('@cleocode/caamp', () => {
    ...
    return {
        ...
        injectAll: vi.fn(async (_providers, projectRoot, _scope, content) => {
        ...
        buildInjectionContent: vi.fn(({ references }) => references.join('\n')),
...
//# sourceMappingURL=injection-chain.test.js.map