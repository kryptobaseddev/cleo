...
describe("version", () => {
    ...
    it.skip("returns version from package.json", async () => {
        ...
        expect(mocks.readFileSync).toHaveBeenCalledWith("/app/package.json", "utf-8");
    });
    ...
    it.skip("calculates correct package.json path from module location", async () => {
        ...
        expect(mocks.readFileSync).toHaveBeenCalledWith("/some/deep/path/package.json", "utf-8");
    });
    ...
    it("handles Windows-style paths", async () => {
        ...
        expect(mocks.readFileSync).toHaveBeenCalledWith(expect.stringContaining("package.json"), "utf-8");
    });
    ...
    it("reads package.json with proper encoding", async () => {
        ...
        const { getCaampVersion: getVersion } = await import("../../src/core/version.js");
        getVersion();
        expect(mocks.readFileSync).toHaveBeenCalledWith(expect.any(String), "utf-8");
    });
