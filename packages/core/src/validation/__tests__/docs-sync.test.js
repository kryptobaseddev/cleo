...
import { checkCommandsSync, detectDrift, getIndexCommands, getIndexScripts, getScriptCommands, shouldRunDriftDetection, } from '../docs-sync.js';
// ============================================================================
// Test helpers
// ============================================================================
function makeRoot() {
...
function makeScriptsDir(root, scripts) {
...
function makeCommandsIndex(root, commands) {
