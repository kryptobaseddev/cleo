...
import { discoverSkill, discoverSkills, discoverSkillsMulti, parseSkillFile, } from "../../src/core/skills/discovery.js";
...
# Same Skill`);
        ...
        it("handles non-existent directories in list", async () => {
            mocks.existsSync.mockImplementation((path) => !path.includes("nonexistent"));
            mocks.readdir.mockResolvedValue([
                { name: "skill1", isDirectory: () => true, isSymbolicLink: () => false },
            ]);
            mocks.readFile.mockResolvedValue(`---
...
//# sourceMappingURL=skills-discovery.test.js.map