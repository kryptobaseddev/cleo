 ...
 *
 * Thin re-export from core's templates/parser, adapting the core
 * TemplateResult type to the gateway EngineResult type.
 *
 * All business logic lives in `@cleocode/core/internal`.
 * This file preserves backward compatibility for existing importers.
 *
 * @remarks
 * Relocated from `packages/cleo/src/dispatch/engines/template-parser.ts` into
 * `@cleocode/runtime/gateway` (R3-K1 · T11455 · SG-RUNTIME-UNIFICATION) as a
 * dependency of the relocated engine barrel.
 *
 * @task T5705
 * @task T11455
 * @epic T5701
...
import type { EngineResult } from './engine-error.js';
