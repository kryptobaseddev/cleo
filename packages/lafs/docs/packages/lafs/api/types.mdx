...
| `source` | `"flag" \| "project" \| "user" \| "default"` | Yes      | Which configuration layer determined the format value.                                     |
...
| `keyword` | `string`                  | Yes      | The AJV validation keyword that triggered the error (e.g., `"required"`, `"type"`). |
| `message` | `string`                  | Yes      | Human-readable description of the validation failure.                               |
| `params`  | `Record<string, unknown>` | Yes      | Keyword-specific parameters from AJV (e.g., `{ missingProperty: "success" }`).      |
...
| `validation`          | `EnvelopeValidationResult`       | Yes      | Schema validation result from AJV.                                                             |
...
| `warnings`       | `import("./types.js").Warning[] \| undefined` | No       | Non-fatal warnings to attach to the envelope metadata.                       |
...
| `page`        | `import("./types.js").LAFSPage \| null \| undefined`           | No       | Pagination metadata for collection results.                                      |
...
| `error`       | `Partial<LAFSError> & Pick<LAFSError, "code" \| "message">`                 | Yes      | Partial error object; at minimum `code` and `message` are required.                                                                                                                                                                                                                                                                                                                              |
...
| `page`        | `import("./types.js").LAFSPage \| null \| undefined`                        | No       | Pagination metadata, if applicable even in error scenarios.                                                                                                                                                                                                                                                                                                                                      |
| `_extensions` | `Record<string, unknown> \| undefined`                                      | No       | Vendor or protocol extension data.                                                                                                                                                                                                                                                                                                                                                               |
| `meta`        | `CreateEnvelopeMetaInput`                                                   | Yes      | Metadata input for constructing the envelope's `_meta` block.                                                                                                                                                                                                                                                                                                                                    |
...
| `mviSource`        | `"flag" \| "default"`   | Yes      | Which input determined the mvi value: `'flag'` when mviFlag was valid, `'default'` otherwise.                                                                           |
...
| `status`   | `"error" \| "ok" \| "warning"` | Yes      | Outcome status of the check.                              |
