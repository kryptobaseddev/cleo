...
Knowledge graph is disabled. To activate:
  ...
  node /tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
