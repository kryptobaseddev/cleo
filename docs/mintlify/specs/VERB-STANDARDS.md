<!-- Source of truth: docs/specs/VERB-STANDARDS.md. Keep in sync. -->
# CLEO Verb Standards
...
| Schedule work | `schedule` | `defer`, `plan`, `queue` (when scheduling tasks) | Enforced |
...
**MCP Usage**: `tasks.compute`, `orchestrate.compute`

---

### 33. Schedule (Defer Work)

**Standard**: `schedule`
**Replaces**: `defer`, `plan`, `queue` (when scheduling tasks for future execution)
