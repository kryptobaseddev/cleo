...
Intel system is disabled. To activate:
  ...
  node /tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
