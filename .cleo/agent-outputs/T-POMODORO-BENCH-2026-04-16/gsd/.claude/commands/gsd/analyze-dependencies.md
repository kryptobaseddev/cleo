...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/analyze-dependencies.md
</execution_context>
...
<process>
Execute the analyze-dependencies workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/analyze-dependencies.md end-to-end.
