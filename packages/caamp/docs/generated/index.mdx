...
**caamp** is a TypeScript documentation toolkit that performs a single AST traversal of your project and produces API docs, OpenAPI specs, executable doctests, and AI context files in one pass.
...
| Package                  | Description             |
| ------------------------ | ----------------------- |
| [`.`](/packages/./index) | 581 exported symbol(s). |
