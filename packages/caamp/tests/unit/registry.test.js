...
import { buildSkillsMap, getAllProviders, getCommonHookEvents, getInstructionFiles, getProvider, getProviderCapabilities, getProviderCount, getProvidersByHookEvent, getProvidersByInstructFile, getProvidersByPriority, getProvidersBySkillsPrecedence, getProvidersBySpawnCapability, getProvidersByStatus, getRegistryVersion, getSpawnCapableProviders, providerSupports, providerSupportsById, resetRegistry, getEffectiveSkillsPaths, resolveAlias, } from "../../src/core/registry/providers.js";
beforeEach(() => {
    resetRegistry();
});
