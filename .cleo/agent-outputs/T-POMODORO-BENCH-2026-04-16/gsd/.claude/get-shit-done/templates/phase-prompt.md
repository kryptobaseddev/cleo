...
<!-- For checkpoint task examples and patterns, see @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/references/checkpoints.md -->
...
See `/tmp/pomodoro-bench/gsd/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
