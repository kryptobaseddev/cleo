...
import { cleanupIntegrationTest, setupIntegrationTest, startTestSession, } from '../../__tests__/integration-setup.js';
describe('query Gateway Integration', () => {
    ...
    describe('Admin Domain', () => {
        it('should get CLEO version', async () => {
            ...
            expect(d?.version || d?.data?.version || d?.cleo || result.stdout?.match(/\d+\.\d+/)).toBeDefined();
        });
