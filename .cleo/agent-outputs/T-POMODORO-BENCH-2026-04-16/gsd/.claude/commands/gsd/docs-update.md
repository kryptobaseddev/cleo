...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/docs-update.md end-to-end.
