...
const FILE_DOMAIN = {
  ...
  'packages/core/src/store/schema/chain-schema.ts': { scope: 'tasks', prefix: 'tasks_' },
  ...
  'packages/core/src/store/schema/code-index.ts': { scope: 'brain', prefix: 'nexus_' },
  'packages/core/src/store/schema/playbooks.ts': { scope: 'tasks', prefix: 'tasks_' },
};
