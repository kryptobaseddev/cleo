...
describe('sqlite-backup', () => {
    ...
    it('calls PRAGMA wal_checkpoint(TRUNCATE) before VACUUM INTO', async () => {
        ...
        const walIdx = calls.findIndex((c) => c.includes('wal_checkpoint'));
        const vacuumIdx = calls.findIndex((c) => c.includes('VACUUM INTO'));
...
//# sourceMappingURL=sqlite-backup.test.js.map