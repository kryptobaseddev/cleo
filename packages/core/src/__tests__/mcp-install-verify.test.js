...
import { caampResolveAlias, mcpConfigPath, providerCount, providerDetect, providerGet, providerInstalled, providerList, registryVersion, } from '../caamp/index.js';
...
describe('MCP server auto-install verification (T4695)', () => {
    describe('Environment detection', () => {
        ...
        it('dev-ts mode generates node command with dist/mcp/index.js', () => {
            ...
            const argPath = entry.args[0].replaceAll('\\', '/');
    ...
    describe('CAAMP adapter exports completeness', () => {
        it('all expected functions are exported from caamp/index', async () => {
            ...
            for (const fn of expectedFunctions) {
                expect(typeof caampExports[fn]).toBe('function');
            }
        });
    });
});
//# sourceMappingURL=mcp-install-verify.test.js.map