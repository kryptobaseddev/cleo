...
describe('T695 — session-bucket pair grouping (real SQLite)', () => {
  ...
  // T695-1 (O(n²) complexity canary) was moved to brain-stdp-wave3.perf.test.ts
  // (gated by RUN_PERF=1) because it runs 6 DB cycles × 3 trials under vitest
  // parallel workers and flaked on contended CI (T1093/T1517). Behavioral coverage
  // for T695 session-bucketing is provided by T695-2/T695-3/T695-4 below.
