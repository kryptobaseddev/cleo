...
<reference>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/tmp/pomodoro-bench/gsd/.claude/get-shit-done/references/user-profiling.md` to load:
