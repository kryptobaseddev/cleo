...
description: "Multi-agent validation and decision protocol"
icon: "users"
---

{/* AUTO-GENERATED from protocols/consensus.md - DO NOT EDIT DIRECTLY */}
{/* Source of truth: /protocols/consensus.md */}
