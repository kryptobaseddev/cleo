/**
 * Default configuration values for the CLEO dispatch layer.
 *
 * @task T2928
 * @task T3145
 * @task T2916 - Rate limiting configuration
 */

import type { RateLimitingConfig } from '../middleware/rate-limiter.js';

export type { RateLimitingConfig } from '../middleware/rate-limiter.js';

import { DEFAULT_RATE_LIMITING } from '../middleware/rate-limiter.js';

export { DEFAULT_RATE_LIMITING } from '../middleware/rate-limiter.js';
