...
import { getMutateDomains, getMutateOperationCount, getMutateOperations, handleMutateRequest, isIdempotentOperation, isMutateOperation, MUTATE_OPERATIONS, registerMutateTool, requiresSession, validateMutateParams, } from '../mutate.js';
const ADVANCED_MEMORY_MUTATE_OPS = ['pattern.store', 'learning.store'];
describe('MUTATE_OPERATIONS', () => {
    ...
    it('should have correct operation counts per domain', () => {
        ...
        expect(MUTATE_OPERATIONS.admin.length).toBe(17);
...
describe('getMutateOperationCount', () => {
    ...
    it('should return domain-specific counts', () => {
        ...
        expect(getMutateOperationCount('admin')).toBe(17);
