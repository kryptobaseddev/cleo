...
description: "Code implementation and execution protocol"
icon: "code"
---

{/* AUTO-GENERATED from protocols/implementation.md - DO NOT EDIT DIRECTLY */}
{/* Source of truth: /protocols/implementation.md */}
