...
describe('bridgeSessionToMemory', () => {
    ...
    it('uses "none" for empty task completion lists', async () => {
        ...
        expect(mocks.observeBrain).toHaveBeenCalledWith('/tmp/project', expect.objectContaining({
    ...
    it('swallows persistence errors to preserve session-end flow', async () => {
        ...
        await expect(bridgeSessionToMemory('/tmp/project', {
...
//# sourceMappingURL=session-memory-bridge.test.js.map