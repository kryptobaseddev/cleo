---
title: "LLM Task ID System Design"
description: "Immutable specification for flat sequential task IDs with hierarchy via parentId field, optimized for anti-hallucination"
icon: "file-code"
---
...
```json
{
  "hierarchyRules": [
    ...
    {
      "rule": "MAX_SIBLINGS",
      "description": "Maximum children per parent is configurable via hierarchy.maxSiblings (0 = unlimited)",
      "errorCode": 12,
      "severity": "error"
    },
    {
...
| 12        | `E_SIBLING_LIMIT`           | Parent exceeded configured child limit |
