...
| Property        | Type                                                                                                     | Required | Description                                    |
| --------------- | -------------------------------------------------------------------------------------------------------- | -------- | ---------------------------------------------- |
| `agentType`     | `"custom" \| "orchestrator" \| "executor" \| "researcher" \| "architect" \| "validator" \| "documentor"` | Yes      | Agent type.                                    |
...
| `recommendation`       | `"stop" \| "continue" \| "wrap_up" \| "verify_compliance"`                                                                                               | Yes      | recommendation       |
