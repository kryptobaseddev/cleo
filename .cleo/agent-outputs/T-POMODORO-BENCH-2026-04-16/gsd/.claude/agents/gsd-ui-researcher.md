...
Use template from `/tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/tmp/pomodoro-bench/gsd/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/tmp/pomodoro-bench/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
