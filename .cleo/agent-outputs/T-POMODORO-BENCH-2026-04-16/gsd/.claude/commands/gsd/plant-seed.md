...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/plant-seed.md end-to-end.
</process>
