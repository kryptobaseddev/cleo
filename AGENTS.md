...
- `src/mcp/gateways/mutate.ts` - 90 mutate operations (CANONICAL operation registry)
...
- `docs/specs/CLEO-OPERATION-CONSTITUTION.md` - All 209 MCP operations mapped to CLI equivalents (supersedes CLEO-OPERATIONS-REFERENCE.md)
