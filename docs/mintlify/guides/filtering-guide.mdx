---
title: "Task Filtering and Query Guide"
description: "Complete reference for filtering, searching, and querying tasks in CLEO"
---
...
# Save to file
cleo list --format markdown > TASKS.md
