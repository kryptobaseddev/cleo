...
#[async_trait]
impl<C> UserRepository for DieselStore<C>
where
...
#[async_trait]
impl<C> ClaimRepository for DieselStore<C>
where
    C: AsyncConnection + 'static,
    C: diesel_async::AsyncConnection<Backend = diesel::sqlite::Sqlite>,
    C: diesel_async::pooled_connection::PoolableConnection,
...
#[async_trait]
impl<C> ConnectionRepository for DieselStore<C>
where
    C: AsyncConnection + 'static,
    C: diesel_async::AsyncConnection<Backend = diesel::sqlite::Sqlite>,
    C: diesel_async::pooled_connection::PoolableConnection,
{
    ...
    async fn find_by_agents(&self, agent_a: Uuid, agent_b: Uuid) -> Result<Option<Connection>> {
        ...
        // Bidirectional lookup: (a,b) or (b,a).
