...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
