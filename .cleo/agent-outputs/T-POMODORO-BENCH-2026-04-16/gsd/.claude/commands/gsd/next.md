...
<execution_context>
@/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @/tmp/pomodoro-bench/gsd/.claude/get-shit-done/workflows/next.md end-to-end.
</process>
