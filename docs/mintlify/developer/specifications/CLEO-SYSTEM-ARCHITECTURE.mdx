...
description: "High-level CLEO architecture connecting all subsystems through complete lifecycle from idea ingestion to release and feedback."
icon: "file-code"
---
...
3. **Append-only audit log** - All operations logged to todo-log.jsonl
