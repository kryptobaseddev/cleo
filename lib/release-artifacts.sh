...
if [[ -f "$_RELEASE_ARTIFACTS_LIB_DIR/release-config.sh" ]]; then
    source "$_RELEASE_ARTIFACTS_LIB_DIR/release-config.sh"
fi

# Source exit codes
if [[ -f "$_RELEASE_ARTIFACTS_LIB_DIR/exit-codes.sh" ]]; then
    source "$_RELEASE_ARTIFACTS_LIB_DIR/exit-codes.sh"
fi

# Source logging
if [[ -f "$_RELEASE_ARTIFACTS_LIB_DIR/logging.sh" ]]; then
    source "$_RELEASE_ARTIFACTS_LIB_DIR/logging.sh"
fi
