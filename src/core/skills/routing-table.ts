...
export const ROUTING_TABLE: RoutingEntry[] = [
  ...
  { domain: 'memory', operation: 'brain.search', preferredChannel: 'mcp', reason: 'Low overhead search, direct DB access' },
  { domain: 'memory', operation: 'brain.fetch', preferredChannel: 'mcp', reason: 'Direct DB access, structured response' },
  { domain: 'memory', operation: 'brain.timeline', preferredChannel: 'mcp', reason: 'Complex multi-table query, direct DB' },
  { domain: 'memory', operation: 'brain.observe', preferredChannel: 'mcp', reason: 'Direct DB write, no CLI overhead' },
  { domain: 'memory', operation: 'find', preferredChannel: 'mcp', reason: 'Alias for brain.search' },
  { domain: 'memory', operation: 'show', preferredChannel: 'mcp', reason: 'Alias for brain.fetch' },
  { domain: 'memory', operation: 'decision.store', preferredChannel: 'mcp', reason: 'Direct DB write' },
  { domain: 'memory', operation: 'decision.find', preferredChannel: 'mcp', reason: 'Direct DB query' },
  { domain: 'memory', operation: 'learning.store', preferredChannel: 'mcp', reason: 'Direct DB write' },
  { domain: 'memory', operation: 'learning.find', preferredChannel: 'mcp', reason: 'Direct DB query' },
  { domain: 'memory', operation: 'pattern.store', preferredChannel: 'mcp', reason: 'Direct DB write' },
  { domain: 'memory', operation: 'pattern.find', preferredChannel: 'mcp', reason: 'Direct DB query' },

  // === Tasks domain -- MCP preferred for queries, CLI for complex ops ===
  { domain: 'tasks', operation: 'show', preferredChannel: 'mcp', reason: 'Structured JSON response' },
  ...
  { domain: 'tasks', operation: 'next', preferredChannel: 'mcp', reason: 'Algorithm runs in-process' },
  { domain: 'tasks', operation: 'current', preferredChannel: 'mcp', reason: 'Simple DB lookup' },
  { domain: 'tasks', operation: 'plan', preferredChannel: 'mcp', reason: 'Composite view, in-process' },
  ...
  { domain: 'tasks', operation: 'complete', preferredChannel: 'mcp', reason: 'Atomic DB write with hooks' },
  ...
  { domain: 'session', operation: 'end', preferredChannel: 'mcp', reason: 'State transition with hooks' },
  { domain: 'session', operation: 'handoff.show', preferredChannel: 'mcp', reason: 'Structured handoff data' },
  { domain: 'session', operation: 'briefing.show', preferredChannel: 'mcp', reason: 'Composite cold-start' },
  ...
  { domain: 'tools', operation: 'skill.list', preferredChannel: 'mcp', reason: 'Structured catalog' },
  { domain: 'tools', operation: 'skill.show', preferredChannel: 'mcp', reason: 'Structured skill data' },
  { domain: 'tools', operation: 'skill.find', preferredChannel: 'mcp', reason: 'Search response' },
  { domain: 'tools', operation: 'skill.install', preferredChannel: 'either', reason: 'May need shell access' },
  { domain: 'tools', operation: 'provider.list', preferredChannel: 'mcp', reason: 'Structured list' },
  { domain: 'tools', operation: 'provider.detect', preferredChannel: 'mcp', reason: 'Detection result' },
  { domain: 'tools', operation: 'adapter.list', preferredChannel: 'mcp', reason: 'Structured list' },
  { domain: 'tools', operation: 'adapter.show', preferredChannel: 'mcp', reason: 'Structured manifest' },
  { domain: 'tools', operation: 'adapter.activate', preferredChannel: 'mcp', reason: 'State transition' },

  // === Check domain -- MCP preferred (validation results) ===
  { domain: 'check', operation: 'validate', preferredChannel: 'mcp', reason: 'Structured validation' },
  { domain: 'check', operation: 'compliance', preferredChannel: 'mcp', reason: 'Compliance report' },

  // === Pipeline domain -- MCP preferred (lifecycle gates) ===
  { domain: 'pipeline', operation: 'lifecycle.status', preferredChannel: 'mcp', reason: 'Gate status' },
  { domain: 'pipeline', operation: 'release.ship', preferredChannel: 'cli', reason: 'Complex multi-step with git ops' },
  ...
  { domain: 'nexus', operation: 'search', preferredChannel: 'either', reason: 'Cross-project search' },
...
export function getPreferredChannel(
  ...
  const entry = ROUTING_TABLE.find(
    (e) => e.domain === domain && e.operation === operation,
  );
 ...
 */
export function getOperationsByChannel(
  channel: 'mcp' | 'cli' | 'either',
): RoutingEntry[] {
