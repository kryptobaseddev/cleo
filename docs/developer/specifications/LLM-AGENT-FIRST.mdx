---
title: "LLM Agent First"
description: "Authoritative LLM-agent-first CLI design standard with JSON by default, structured errors, and consistent behavior across 34 commands."
icon: "file-code"
---
