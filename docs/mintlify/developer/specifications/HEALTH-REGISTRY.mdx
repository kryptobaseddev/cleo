...
description: "Comprehensive health registry system with central project registry, 36 health checks across 6 dimensions, and LLM-agent-first design."
icon: "file-code"
---
...
| **Session/Operational (SO)** | 5% | Stale sessions, lock files, active task consistency |
...
| RI-006 | Active Task Exists | WARNING | SAFE |
...
| SO-003 | Active Task Consistency | WARNING | SAFE |
  ...
  "autoFixable": [
    {
      "checkId": "RI-006",
      "fixCommand": "ct stop",
      "description": "Clear invalid active task reference"
    }
  ],
  "nextAction": {
    "priority": "high",
