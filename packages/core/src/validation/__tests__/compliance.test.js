...
import { calculateOrchestrationOverhead, calculateTokenEfficiency, checkManifestEntry, checkReturnFormat, scoreSubagentCompliance, } from '../compliance.js';
...
describe('scoreSubagentCompliance', () => {
    it('scores perfect compliance', () => {
        ...
        const result = scoreSubagentCompliance('T1', 'agent-1', entry, true, 'Research complete. See MANIFEST.jsonl for summary.');
    ...
    it('penalizes missing manifest', () => {
        const result = scoreSubagentCompliance('T1', 'agent-1', null, true, 'Research complete. See MANIFEST.jsonl for summary.');
