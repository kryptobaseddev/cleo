...
import { releaseChangelog, releaseCommit, releaseGatesRun, releaseList, releasePrepare, releaseRollback, releaseShow, releaseTag, } from '../release-engine.js';
...
describe('Release Engine', () => {
    ...
    describe('releasePrepare', () => {
        ...
        it('should auto-discover completed tasks', async () => {
            ...
            expect(result.success).toBe(true);
            expect(result.data.taskCount).toBe(2); // T001 and T002
        });
    ...
    describe('releaseTag', () => {
        it('should mark release as tagged', async () => {
            ...
            expect(result.success).toBe(true);
            expect(result.data.status).toBe('tagged');
        });
    });
    ...
    describe('releaseRollback', () => {
        it('should rollback a release', async () => {
            ...
            expect(result.data.previousStatus).toBe('tagged');
        });
    });
});
//# sourceMappingURL=release-engine.test.js.map