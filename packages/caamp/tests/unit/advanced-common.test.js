...
describe("advanced/common", () => {
    ...
    it("resolves providers from all, installed, and agent selections", () => {
        ...
        mocks.getProvider.mockImplementation((id) => (id === "alpha" ? a : undefined));
    ...
    it("throws when selected providers are missing", () => {
        ...
        mocks.getProvider.mockImplementation((id) => (id === "alpha" ? alpha : undefined));
    ...
    it("validates skill operations and text input mode", async () => {
        mocks.readFile.mockResolvedValueOnce(JSON.stringify([{ sourcePath: "./skills/my-skill", skillName: "my-skill", isGlobal: false }]));
...
//# sourceMappingURL=advanced-common.test.js.map