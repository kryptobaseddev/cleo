...
import { checkIdUniqueness, checkTimestampSanity, FIELD_LIMITS, isMetadataOnlyUpdate, isValidStatus, normalizeLabels, sanitizeFilePath, validateAll, validateBlockedBy, validateCancelReason, validateCurrentPhaseConsistency, validateDescription, validateNoCircularDeps, validateNote, validateSessionNote, validateSingleActivePhase, validateStatusTransition, validateTask, validateTitle, } from '../engine.js';
// ============================================================================
// Title Validation
// ============================================================================
...
describe('checkTimestampSanity', () => {
    ...
    it('validates completed_at ordering', () => {
        const result = checkTimestampSanity('2025-01-15T10:00:00Z', '2025-01-14T10:00:00Z');
        expect(result.valid).toBe(false);
    });
});
// ============================================================================
...
describe('checkIdUniqueness', () => {
    ...
    it('fails with cross-file duplicates', () => {
        const result = checkIdUniqueness({ tasks: [{ id: 'T1' }, { id: 'T2' }] }, { archived_tasks: [{ id: 'T2' }, { id: 'T3' }] });
        expect(result.valid).toBe(false);
