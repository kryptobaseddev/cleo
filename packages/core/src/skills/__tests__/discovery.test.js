...
import { discoverSkill, discoverSkillsInDir, getSkillSearchPaths, listCanonicalSkillNames, mapSkillName, parseFrontmatter, toSkillSummary, } from '../discovery.js';
// Test helpers
let testDir;
...
function createSkill(dir, name, frontmatter, body = '') {
