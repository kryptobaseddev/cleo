...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `action` | `"skipped" \| "created" \| "repaired"` | Yes | action |
| `path` | `string` | Yes | path |
...
| `sessionNotes` | `unknown[]` | Yes | sessionNotes |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `focus` | `TaskWorkStateExt \| { [key: string]: unknown; currentTask?: string \| null \| undefined; currentPhase?: string \| null \| undefined; } \| undefined` | No | focus |
| `_meta` | `{ [key: string]: unknown; schemaVersion: string; checksum?: string \| undefined; configVersion?: string \| undefined; lastSessionId?: string \| null \| undefined; activeSessionCount?: number \| undefined; sessionsFile?: string \| ... 1 more ... \| undefined; generation?: number \| undefined; } \| undefined` | No | _meta |
| `tasks` | `{ [key: string]: unknown; id: string; status: string; parentId?: string \| undefined; completedAt?: string \| undefined; }[] \| undefined` | No | tasks |
| `lastUpdated` | `string \| undefined` | No | lastUpdated |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `focus` | `"testing" \| "architecture" \| "stack" \| "structure" \| "conventions" \| "integrations" \| "concerns" \| undefined` | No | focus |
...
| `updateDocs` | `boolean \| undefined` | No | Update agent documentation injections only. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `mode` | `"skipped" \| "manual" \| "created"` | Yes | mode |
...
| `find` | `(params: { query?: string \| undefined; id?: string \| undefined; status?: "cancelled" \| "pending" \| "active" \| "blocked" \| "done" \| "archived" \| undefined; limit?: number \| undefined; }) => Promise<...>` | No | find |
| `show` | `(taskId: string) => Promise<unknown>` | Yes | show |
| `list` | `(params?: { status?: "cancelled" \| "pending" \| "active" \| "blocked" \| "done" \| "archived" \| undefined; priority?: TaskPriority \| undefined; parentId?: string \| undefined; phase?: string \| undefined; limit?: number \| undefined; } \| undefined) => Promise<...>` | No | list |
| `update` | `(params: { taskId: string; title?: string \| undefined; status?: "cancelled" \| "pending" \| "active" \| "blocked" \| "done" \| "archived" \| undefined; priority?: TaskPriority \| undefined; description?: string \| undefined; notes?: string \| undefined; }) => Promise<...>` | No | update |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `reconcile` | `(params: { externalTasks: ExternalTask[]; providerId: string; dryRun?: boolean \| undefined; conflictPolicy?: ConflictPolicy \| undefined; defaultPhase?: string \| undefined; defaultLabels?: string[] \| undefined; }) => Promise<...>` | No | reconcile |
| `readState` | `(providerId: string) => Promise<SyncSessionState \| null>` | Yes | readState |
| `writeState` | `(providerId: string, state: SyncSessionState) => Promise<void>` | Yes | writeState |
| `clearState` | `(providerId: string) => Promise<void>` | Yes | clearState |
...
| `resetStatus` | `"cancelled" \| "pending" \| "active" \| "blocked" \| "done" \| "archived" \| undefined` | No | resetStatus |
...
| `preferredChannel` | `PreferredChannel \| undefined` | No | preferredChannel |
...
| `author` | `string \| undefined` | No | author |
| `tags` | `string[] \| undefined` | No | tags |
| `triggers` | `string[] \| undefined` | No | triggers |
| `dispatchPriority` | `number \| undefined` | No | dispatchPriority |
| `model` | `string \| undefined` | No | model |
| `allowedTools` | `string[] \| undefined` | No | allowedTools |
| `invocable` | `boolean \| undefined` | No | invocable |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `injected_tasks` | `string[]` | Yes | injected_tasks |
| `injectedPhase` | `string \| undefined` | No | injectedPhase |
| `task_metadata` | `Record<string, { phase?: string \| undefined; }> \| undefined` | No | task_metadata |
...
| `progressed` | `string[]` | Yes | progressed |
| `newTasks` | `string[]` | Yes | newTasks |
| `removed` | `string[]` | Yes | removed |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `file` | `string` | Yes | Path to the TodoWrite JSON state file. |
| `dryRun` | `boolean \| undefined` | No | Show changes without modifying tasks. |
...
| `accessor` | `DataAccessor \| undefined` | No | Optional DataAccessor override. |
...
|----------|------|----------|-------------|
| `dryRun` | `boolean` | Yes | dryRun |
| `changes` | `{ completed: number; progressed: number; new: number; removed: number; applied: number; }` | Yes | changes |
| `sessionCleared` | `boolean` | Yes | sessionCleared |
...
| `active` | `boolean` | Yes | active |
| `sessionId` | `string \| undefined` | No | sessionId |
| `injectedAt` | `string \| undefined` | No | injectedAt |
| `injectedPhase` | `string \| undefined` | No | injectedPhase |
| `taskCount` | `number \| undefined` | No | taskCount |
| `taskIds` | `string[] \| undefined` | No | taskIds |
| `phases` | `{ phase: string; count: number; }[] \| undefined` | No | phases |
| `stateFile` | `string` | Yes | stateFile |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `cleared` | `{ stateFile: string; } \| undefined` | No | cleared |
| `dryRun` | `boolean \| undefined` | No | dryRun |
| `wouldDelete` | `{ stateFile: string; syncDirectory: string; } \| undefined` | No | wouldDelete |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `defaultPrecedence` | `SkillsPrecedence \| undefined` | No | defaultPrecedence |
| `providerOverrides` | `Record<string, SkillsPrecedence> \| undefined` | No | providerOverrides |
...
|----------|------|----------|-------------|
| `path` | `string` | Yes | path |
| `source` | `"marketplace" \| "vendor" \| "agents"` | Yes | source |
| `scope` | `"global" \| "project"` | Yes | scope |
| `precedence` | `SkillsPrecedence` | Yes | precedence |
...
| `skillName` | `string` | Yes | skillName |
| `source` | `string` | Yes | source |
| `targetProviders` | `string[]` | Yes | targetProviders |
| `precedenceMode` | `SkillsPrecedence \| undefined` | No | precedenceMode |
| `projectRoot` | `string \| undefined` | No | projectRoot |
...
| `operation` | `string` | Yes | Operation name (e.g. 'brain.search', 'show') |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `pipeline` | `{ id: string; version: number; updatedAt: string \| null; status: "completed" \| "failed" \| "cancelled" \| "active" \| "blocked" \| "aborted"; completedAt: string \| null; taskId: string; startedAt: string; currentStageId: string \| null; }` | Yes | pipeline |
| `stage` | `{ id: string; status: "completed" \| "failed" \| "blocked" \| "not_started" \| "in_progress" \| "skipped"; notesJson: string \| null; completedAt: string \| null; createdBy: string \| null; ... 13 more ...; provenanceChainJson: string \| null; }` | Yes | stage |
| `task` | `{ sessionId: string \| null; id: string; description: string \| null; createdAt: string; updatedAt: string \| null; status: "cancelled" \| "pending" \| "active" \| "blocked" \| "done" \| "archived"; ... 24 more ...; modifiedBy: string \| null; }` | Yes | task |
...
|----------|------|----------|-------------|
| `pipeline` | `{ id: string; version: number; updatedAt: string \| null; status: "completed" \| "failed" \| "cancelled" \| "active" \| "blocked" \| "aborted"; completedAt: string \| null; taskId: string; startedAt: string; currentStageId: string \| null; }` | Yes | pipeline |
| `stageRecord` | `{ id: string; status: "completed" \| "failed" \| "blocked" \| "not_started" \| "in_progress" \| "skipped"; notesJson: string \| null; completedAt: string \| null; createdBy: string \| null; ... 13 more ...; provenanceChainJson: string \| null; }` | Yes | stageRecord |
...
|----------|------|----------|-------------|
| `taskId` | `string` | Yes | taskId |
| `newParentId` | `string \| null` | Yes | New parent ID, or null to promote to root. |
| `policy` | `HierarchyPolicy \| undefined` | No | Optional resolved hierarchy policy. If not provided, uses llm-agent-first defaults. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `oldParent` | `string \| null` | Yes | oldParent |
| `newParent` | `string \| null` | Yes | newParent |
| `newType` | `string` | Yes | newType |
