...
description: "Why CLEO works the way it does - core design decisions for AI agent task management"
---
...
**Session data persists** in `todo-log.jsonl`—enabling context recovery across sessions, agent handoffs, and debugging.
...
```bash
cleo start T042  # Marks T042 active, others pending
```
