...
import { canExecute, canRead, canWrite, checkPermission, checkPermissionDetail, permissionLevel, requirePermission, } from '../permissions.js';
...
describe('requirePermission', () => {
    ...
    it('throws CleoError when permission is insufficient', async () => {
        await nexusRegister(projectDir, 'read-proj', 'read');
        await expect(requirePermission('read-proj', 'write', 'update task')).rejects.toThrow(/Permission denied/);
    });
});
