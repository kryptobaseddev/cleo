import { g as getNexusDb, a as getBrainDb, b as getTasksDb } from './connections-iyzH8dC3.js';
import 'node:module';
import 'node:fs';
import 'node:os';
import 'node:path';
...
const index = 2;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-CAw1ObRp.js')).default;
const server_id = "src/routes/+page.server.ts";
const imports = ["_app/immutable/nodes/2.BlRf6O6p.js","_app/immutable/chunks/FR9iDC2_.js","_app/immutable/chunks/CFKVnMbq.js"];
const stylesheets = ["_app/immutable/assets/2.4tNR_TUx.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=2-BDGrNySv.js.map
