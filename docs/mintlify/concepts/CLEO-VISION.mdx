...
| **sticky** | Scratch Pad | Ephemeral capture before formal encoding. The sticky domain provides lightweight quick-capture notes that exist before formal task or memory creation. |
