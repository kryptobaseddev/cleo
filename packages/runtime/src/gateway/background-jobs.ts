 ...
 * `@cleocode/runtime/gateway` (R3-K1 · T11455 · SG-RUNTIME-UNIFICATION) as the
 * type backing the relocated {@link ./job-manager-accessor.js} singleton, so the
 * runtime owns the shared handler dependencies. A thin re-export shim remains at
 * the old path.
 *
 * @task T641
 * @task T11455
