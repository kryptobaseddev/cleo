...
import { pipelineManifestAppend, pipelineManifestArchive, pipelineManifestFind, pipelineManifestList, pipelineManifestShow, pipelineManifestStats, } from '../../lib/engine.js';
...
describe('PipelineHandler manifest operations', () => {
    ...
    describe('query: manifest.show', () => {
        it('should return manifest entry by ID', async () => {
            ...
            expect(result.data.id).toBe('R001');
    ...
    describe('query: manifest.list', () => {
        ...
        it('should pass filter params', async () => {
            ...
            expect(pipelineManifestList).toHaveBeenCalledWith(expect.objectContaining({ type: 'research', status: 'completed' }), '/mock/project');
        });
    });
    // =========================================================================
    // Query: manifest.find
    ...
    describe('query: manifest.find', () => {
        it('should search manifest entries by text', async () => {
            ...
            expect(result.success).toBe(true);
            expect(pipelineManifestFind).toHaveBeenCalledWith('authentication', { confidence: undefined, limit: undefined }, '/mock/project');
        });
        it('should pass confidence and limit params', async () => {
            ...
            expect(pipelineManifestFind).toHaveBeenCalledWith('auth', { confidence: 0.5, limit: 10 }, '/mock/project');
        });
...
//# sourceMappingURL=pipeline-manifest.test.js.map