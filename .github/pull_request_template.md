...
- [ ] Ran `pnpm test` (Vitest)
- [ ] Ran `pnpm typecheck` (TypeScript)
- [ ] Ran `pnpm build`
...
<!-- These are requirements from AGENTS.md. Check all that apply. -->
...
- [ ] Verb standards: Using canonical verbs (add/show/find, not create/get/search)

## Environment

<!-- Run this and paste the output (optional but helpful for debugging): -->
<!-- echo "CLEO: $(cleo version)" && echo "Node: $(node --version)" && echo "OS: $(uname -srm)" -->
