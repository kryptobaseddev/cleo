...
│ - Runs every ~300ms                                         │
│ - Writes context-state-{sessionId}.json to .cleo/context-states/ │
...
cleo session start --scope epic:T001 --auto-focus
# → Context tracked in .cleo/context-states/context-state-session_abc123.json

# Agent 2: Working on UI epic
cleo session start --scope epic:T050 --auto-focus
# → Context tracked in .cleo/context-states/context-state-session_xyz789.json
```
