...
<Update label="January 2026" description="v0.57.4" tags={["Fix", "Feature", "Installer"]}>
## Installer
...
[View full release notes](https://github.com/kryptobaseddev/cleo/releases/tag/v0.57.4)
</Update>
