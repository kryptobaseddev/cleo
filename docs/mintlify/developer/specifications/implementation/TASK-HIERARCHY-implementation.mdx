---
title: "Task Hierarchy Implementation"
description: "Implementation details for the hierarchical task organization system with epic/task/subtask relationships"
icon: "code"
---
...
| `current` hierarchy context | PENDING | - | Phase 2 |
...
- [x] `scripts/add.sh` - `--type`, `--parent`, `--size` flags
- [ ] `scripts/list.sh` - `--tree`, `--children`, `--type` flags
...
- [ ] Active task shows hierarchy context
