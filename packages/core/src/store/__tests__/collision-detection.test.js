...
describe('Collision Detection', () => {
    ...
    describe('checkTaskExists', () => {
        ...
        it('should detect existing task ID in strict mode', async () => {
            ...
            await expect(checkTaskExists('T001', tempDir, { strictMode: true })).rejects.toThrow('collision');
        });
    ...
    describe('Race Condition Simulation', () => {
        it('should handle rapid successive ID checks without false positives', async () => {
            ...
            const results = await Promise.all(Array.from({ length: 10 }, (_, i) => checkTaskExists(`T${i + 100}`, tempDir, { strictMode: false })));
...
//# sourceMappingURL=collision-detection.test.js.map