...
export const COMMAND_MANIFEST: readonly CommandManifestEntry[] = [
  ...
  },
  {
    ...
    description: 'Report tasks whose acceptance criteria disagree between the JSON column and the typed rows ',
    load: async () => (await import('../commands/doctor-acceptance-drift.js')).doctorAcceptanceDriftCommand as CommandDef,
  },
  {
  ...
  },
  {
    ...
    load: async () => (await import('../commands/doctor-fk-check.js')).doctorFkCheckCommand as CommandDef,
  },
  {
  ...
  },
  {
    ...
    load: async () => (await import('../commands/doctor-legacy-reaper.js')).doctorLegacyReaperCommand as CommandDef,
  },
  {
    exportName: 'doctorMalformedIdsCommand',
    name: 'malformed-ids',
    description: 'Report task rows whose id is not a valid task identifier — rows that ',
    load: async () => (await import('../commands/doctor-malformed-ids.js')).doctorMalformedIdsCommand as CommandDef,
  },
  {
    exportName: 'doctorMemoryGuardCommand',
    name: 'memory-guard',
    description: 'Audit the machine-wide memory guard that bounds test runs an agent starts OUTSIDE cleo ',
    load: async () => (await import('../commands/doctor-memory-guard.js')).doctorMemoryGuardCommand as CommandDef,
  },
  {
    exportName: 'doctorNexusResidencyCommand',
    name: 'nexus-residency',
    description: 'Report nexus tables resident in the wrong store — graph tables orphaned in the global ',
    load: async () => (await import('../commands/doctor-nexus-residency.js')).doctorNexusResidencyCommand as CommandDef,
  },
  {
  ...
  },
  {
    ...
    description: 'Report pre-dual-scope store files (.cleo/tasks.db, .cleo/brain.db) still on disk under ',
    load: async () => (await import('../commands/doctor-superseded-store.js')).doctorSupersededStoreCommand as CommandDef,
  },
  {
    exportName: 'doctorToolLocksCommand',
    name: 'tool-locks',
    description: 'Inspect the machine-wide evidence-tool semaphore: which slots are held, by which pid, ',
    load: async () => (await import('../commands/doctor-tool-locks.js')).doctorToolLocksCommand as CommandDef,
  },
  {
